...
(this.useUTC=h)&&d.timezoneOffset||void 0;this.getTimezoneOffset=this.timezoneOffsetFunction();this.variableTimezone=h&&!(!d.getTimezoneOffset&&!d.timezone)};r.prototype.makeTime=function(d,h,r,m,x,c){if(this.useUTC){var u=this.Date.UTC.apply(0,arguments),f=this.getTimezoneOffset(u);u+=f;var l=this.getTimezoneOffset(u);f!==l?u+=l-f:f-36E5!==this.getTimezoneOffset(u-36E5)||k||(u-=36E5)}else u=(new this.Date(d,h,e(r,1),e(m,0),e(x,0),e(c,0))).getTime();return u};r.prototype.timezoneOffsetFunction=function(){var d=
this,e=this.options,h=e.getTimezoneOffset,k=e.moment||z.moment;if(!this.useUTC)return function(d){return 6E4*(new Date(d.toString())).getTimezoneOffset()};if(e.timezone){if(k)return function(d){return 6E4*-k.tz(d,e.timezone).utcOffset()};C(25)}return this.useUTC&&h?function(d){return 6E4*h(d.valueOf())}:function(){return 6E4*(d.timezoneOffset||0)}};r.prototype.dateFormat=function(d,h,k){if(!E(h)||isNaN(h))return a.defaultOptions.lang&&a.defaultOptions.lang.invalidDate||"";d=e(d,"%Y-%m-%d %H:%M:%S");
...
month:"%B %Y",year:"%Y"},footerFormat:"",headerShape:"callout",hideDelay:500,padding:8,shape:"callout",shared:!1,snap:y.isTouchDevice?25:10,headerFormat:'\x3cspan style\x3d"font-size: 10px"\x3e{point.key}\x3c/span\x3e\x3cbr/\x3e',pointFormat:'\x3cspan style\x3d"color:{point.color}"\x3e\u25cf\x3c/span\x3e {series.name}: \x3cb\x3e{point.y}\x3c/b\x3e\x3cbr/\x3e',backgroundColor:g("#f7f7f7").setOpacity(.85).get(),borderWidth:1,shadow:!0,stickOnContact:!1,style:{color:"#333333",cursor:"default",fontSize:"12px",
whiteSpace:"nowrap"},useHTML:!1},credits:{enabled:!0,href:"https://www.highcharts.com?credits",position:{align:"right",x:-10,verticalAlign:"bottom",y:-5},style:{cursor:"pointer",color:"#999999",fontSize:"9px"},text:"Highcharts.com"}};t.chart.styledMode=!1;"";var q=new C(z(t.global,t.time));a={defaultOptions:t,defaultTime:q,getOptions:function(){return t},setOptions:function(n){z(!0,t,n);if(n.time||n.global)y.time?y.time.update(z(t.global,t.time,n.global,n.time)):y.time=q;return t}};"";return a});
L(g,"Core/Animation/Fx.js",[g["Core/Color/Color.js"],g["Core/Globals.js"],g["Core/Utilities.js"]],function(a,g,y){var z=a.parse,C=g.win,D=y.isNumber,J=y.objectEach;return function(){function a(a,n,e){this.pos=NaN;this.options=n;this.elem=a;this.prop=e}a.prototype.dSetter=function(){var a=this.paths,n=a&&a[0];a=a&&a[1];var e=this.now||0,d=[];if(1!==e&&n&&a)if(n.length===a.length&&1>e)for(var h=0;h<a.length;h++){for(var m=n[h],k=a[h],r=[],B=0;B<k.length;B++){var G=m[B],K=k[B];D(G)&&D(K)&&("A"!==k[0]||
4!==B&&5!==B)?r[B]=G+e*(K-G):r[B]=K}d.push(r)}else d=a;else d=this.toD||[];this.elem.attr("d",d,void 0,!0)};a.prototype.update=function(){var a=this.elem,n=this.prop,e=this.now,d=this.options.step;if(this[n+"Setter"])this[n+"Setter"]();else a.attr?a.element&&a.attr(n,e,null,!0):a.style[n]=e+this.unit;d&&d.call(a,e,this)};a.prototype.run=function(q,n,e){var d=this,h=d.options,m=function(e){return m.stopped?!1:d.step(e)},k=C.requestAnimationFrame||function(d){setTimeout(d,13)},r=function(){for(var d=
0;d<a.timers.length;d++)a.timers[d]()||a.timers.splice(d--,1);a.timers.length&&k(r)};q!==n||this.elem["forceAnimate:"+this.prop]?(this.startTime=+new Date,this.start=q,this.end=n,this.unit=e,this.now=this.start,this.pos=0,m.elem=this.elem,m.prop=this.prop,m()&&1===a.timers.push(m)&&k(r)):(delete h.curAnim[this.prop],h.complete&&0===Object.keys(h.curAnim).length&&h.complete.call(this.elem))};a.prototype.step=function(a){var n=+new Date,e=this.options,d=this.elem,h=e.complete,m=e.duration,k=e.curAnim;
if(d.attr&&!d.element)a=!1;else if(a||n>=m+this.startTime){this.now=this.end;this.pos=1;this.update();var r=k[this.prop]=!0;J(k,function(d){!0!==d&&(r=!1)});r&&h&&h.call(d);a=!1}else this.pos=e.easing((n-this.startTime)/m),this.now=this.start+(this.end-this.start)*this.pos,this.update(),a=!0;return a};a.prototype.initPath=function(a,n,e){function d(d,c){for(;d.length<I;){var e=d[0],f=c[I-d.length];f&&"M"===e[0]&&(d[0]="C"===f[0]?["C",e[1],e[2],e[1],e[2],e[1],e[2]]:["L",e[1],e[2]]);d.unshift(e);r&&
(e=d.pop(),d.push(d[d.length-1],e))}}function h(d,c){for(;d.length<I;)if(c=d[Math.floor(d.length/B)-1].slice(),"C"===c[0]&&(c[1]=c[5],c[2]=c[6]),r){var e=d[Math.floor(d.length/B)].slice();d.splice(d.length/2,0,c,e)}else d.push(c)}var m=a.startX,k=a.endX;e=e.slice();var r=a.isArea,B=r?2:1;n=n&&n.slice();if(!n)return[e,e];if(m&&k&&k.length){for(a=0;a<m.length;a++)if(m[a]===k[0]){var G=a;break}else if(m[0]===k[k.length-m.length+a]){G=a;var K=!0;break}else if(m[m.length-1]===k[k.length-m.length+a]){G=
m.length-a;break}"undefined"===typeof G&&(n=[])}if(n.length&&D(G)){var I=e.length+G*B;K?(d(n,e),h(e,n)):(d(e,n),h(n,e))}return[n,e]};a.prototype.fillSetter=function(){a.prototype.strokeSetter.apply(this,arguments)};a.prototype.strokeSetter=function(){this.elem.attr(this.prop,z(this.start).tweenTo(z(this.end),this.pos),void 0,!0)};a.timers=[];return a}()});L(g,"Core/Animation/AnimationUtilities.js",[g["Core/Animation/Fx.js"],g["Core/Utilities.js"]],function(a,g){function z(d){return q(d)?n({duration:500,
defer:0},d):{duration:d?500:0,defer:0}}function E(d,e){for(var k=a.timers.length;k--;)a.timers[k].elem!==d||e&&e!==a.timers[k].prop||(a.timers[k].stopped=!0)}var C=g.defined,D=g.getStyle,J=g.isArray,t=g.isNumber,q=g.isObject,n=g.merge,e=g.objectEach,d=g.pick;return{animate:function(d,m,k){var h,B="",G,K;if(!q(k)){var g=arguments;k={duration:g[2],easing:g[3],complete:g[4]}}t(k.duration)||(k.duration=400);k.easing="function"===typeof k.easing?k.easing:Math[k.easing]||Math.easeInOutSine;k.curAnim=n(m);
e(m,function(e,c){E(d,c);K=new a(d,k,c);G=void 0;"d"===c&&J(m.d)?(K.paths=K.initPath(d,d.pathArray,m.d),K.toD=m.d,h=0,G=1):d.attr?h=d.attr(c):(h=parseFloat(D(d,c))||0,"opacity"!==c&&(B="px"));G||(G=e);"string"===typeof G&&G.match("px")&&(G=G.replace(/px/g,""));K.run(h,G,B)})},animObject:z,getDeferredAnimation:function(d,e,k){var h=z(e),m=0,a=0;(k?[k]:d.series).forEach(function(d){d=z(d.options.animation);m=e&&C(e.defer)?h.defer:Math.max(m,d.duration+d.defer);a=Math.min(h.duration,d.duration)});d.renderer.forExport&&
(m=0);return{defer:Math.max(0,m-a),duration:Math.min(m,a)}},setAnimation:function(e,m){m.renderer.globalAnimation=d(e,m.options.chart.animation,!0)},stop:E}});L(g,"Core/Renderer/HTML/AST.js",[g["Core/Globals.js"],g["Core/Utilities.js"]],function(a,g){var z=a.SVG_NS,E=g.attr,C=g.createElement,D=g.css,J=g.error,t=g.isFunction,q=g.isString,n=g.objectEach,e=g.splat,d=(g=a.win.trustedTypes)&&t(g.createPolicy)&&g.createPolicy("highcharts",{createHTML:function(d){return d}}),h=d?d.createHTML(""):"";try{var m=
!!(new DOMParser).parseFromString(h,"text/html")}catch(k){m=!1}t=function(){function k(d){this.nodes="string"===typeof d?this.parseMarkup(d):d}k.filterUserAttributes=function(d){n(d,function(e,h){var m=!0;-1===k.allowedAttributes.indexOf(h)&&(m=!1);-1!==["background","dynsrc","href","lowsrc","src"].indexOf(h)&&(m=q(e)&&k.allowedReferences.some(function(d){return 0===e.indexOf(d)}));m||(J(33,!1,void 0,{"Invalid attribute in config":"".concat(h)}),delete d[h]);q(e)&&d[h]&&(d[h]=e.replace(/</g,"\x26lt;"))});
return d};k.parseStyle=function(d){return d.split(";").reduce(function(d,e){e=e.split(":").map(function(d){return d.trim()});var h=e.shift();h&&e.length&&(d[h.replace(/-([a-z])/g,function(d){return d[1].toUpperCase()})]=e.join(":"));return d},{})};k.setElementHTML=function(d,e){d.innerHTML=k.emptyHTML;e&&(new k(e)).addToDOM(d)};k.prototype.addToDOM=function(d){function h(d,m){var r;e(d).forEach(function(d){var c=d.tagName,e=d.textContent?a.doc.createTextNode(d.textContent):void 0,f=k.bypassHTMLFiltering;
if(c)if("#text"===c)var l=e;else if(-1!==k.allowedTags.indexOf(c)||f){c=a.doc.createElementNS("svg"===c?z:m.namespaceURI||z,c);var b=d.attributes||{};n(d,function(c,f){"tagName"!==f&&"attributes"!==f&&"children"!==f&&"style"!==f&&"textContent"!==f&&(b[f]=c)});E(c,f?b:k.filterUserAttributes(b));d.style&&D(c,d.style);e&&c.appendChild(e);h(d.children||[],c);l=c}else J(33,!1,void 0,{"Invalid tagName in config":c});l&&m.appendChild(l);r=l});return r}return h(this.nodes,d)};k.prototype.parseMarkup=function(e){var h=
[];e=e.trim().replace(/ style=(["'])/g," data-style\x3d$1");if(m)e=(new DOMParser).parseFromString(d?d.createHTML(e):e,"text/html");else{var r=C("div");r.innerHTML=e;e={body:r}}var a=function(d,e){var c=d.nodeName.toLowerCase(),h={tagName:c};"#text"===c&&(h.textContent=d.textContent||"");if(c=d.attributes){var f={};[].forEach.call(c,function(b){"data-style"===b.name?h.style=k.parseStyle(b.value):f[b.name]=b.value});h.attributes=f}if(d.childNodes.length){var l=[];[].forEach.call(d.childNodes,function(b){a(b,
l)});l.length&&(h.children=l)}e.push(h)};[].forEach.call(e.body.childNodes,function(d){return a(d,h)});return h};k.allowedAttributes="aria-controls aria-describedby aria-expanded aria-haspopup aria-hidden aria-label aria-labelledby aria-live aria-pressed aria-readonly aria-roledescription aria-selected class clip-path color colspan cx cy d dx dy disabled fill height href id in markerHeight markerWidth offset opacity orient padding paddingLeft paddingRight patternUnits r refX refY role scope slope src startOffset stdDeviation stroke stroke-linecap stroke-width style tableValues result rowspan summary target tabindex text-align text-anchor textAnchor textLength title type valign width x x1 x2 xlink:href y y1 y2 zIndex".split(" ");
...
"font-size"):w&&w.fontSize,u;if(B(v)){var m=v.toString();-1===m.indexOf("\x3c")&&(m=m.replace(/[0-9]/g,"0"));m+=["",d,H,this.textWidth,l,w&&w.textOverflow,w&&w.fontWeight].join()}m&&!f&&(u=h[m]);if(!u){if(k||p.forExport){try{var F=this.fakeTS&&function(b){var c=e.querySelector(".highcharts-text-outline");c&&r(c,{display:b})};c(F)&&F("none");u=e.getBBox?K({},e.getBBox()):{width:e.offsetWidth,height:e.offsetHeight,x:0,y:0};c(F)&&F("")}catch(U){""}if(!u||0>u.width)u={x:0,y:0,width:0,height:0}}else u=
this.htmlGetBBox();if(p.isSVG&&(p=u.width,f=u.height,k&&(u.height=f={"11px,17":14,"13px,20":16}["".concat(H||"",",").concat(Math.round(f))]||f),d)){k=Number(e.getAttribute("y")||0)-u.y;l={right:1,center:.5}[l||0]||0;w=d*t;H=(d-90)*t;var x=p*Math.cos(w);d=p*Math.sin(w);F=Math.cos(H);w=Math.sin(H);p=u.x+l*(p-x)+k*F;H=p+x;F=H-f*F;x=F-x;k=u.y+k-l*d+k*w;l=k+d;f=l-f*w;d=f-d;u.x=Math.min(p,H,F,x);u.y=Math.min(k,l,f,d);u.width=Math.max(p,H,F,x)-u.x;u.height=Math.max(k,l,f,d)-u.y}if(m&&(""===v||0<u.height)){for(;250<
A.length;)delete h[A.shift()];h[m]||A.push(m);h[m]=u}}return u};a.prototype.getStyle=function(b){return d.getComputedStyle(this.element||this,"").getPropertyValue(b)};a.prototype.hasClass=function(b){return-1!==(""+this.attr("class")).split(" ").indexOf(b)};a.prototype.hide=function(){return this.attr({visibility:"hidden"})};a.prototype.htmlGetBBox=function(){return{height:0,width:0,x:0,y:0}};a.prototype.init=function(b,c){this.element="span"===c?k(c):q.createElementNS(this.SVG_NS,c);this.renderer=
b;I(this,"afterInit")};a.prototype.on=function(b,c){var f=this.onEvents;if(f[b])f[b]();f[b]=h(this.element,b,c);return this};a.prototype.opacitySetter=function(b,c,f){this.opacity=b=Number(Number(b).toFixed(3));f.setAttribute(c,b)};a.prototype.removeClass=function(b){return this.attr("class",(""+this.attr("class")).replace(u(b)?new RegExp("(^| )".concat(b,"( |$)")):b," ").replace(/ +/g," ").trim())};a.prototype.removeTextOutline=function(){var b=this.element.querySelector("tspan.highcharts-text-outline");
b&&this.safeRemoveChild(b)};a.prototype.safeRemoveChild=function(b){var c=b.parentNode;c&&c.removeChild(b)};a.prototype.setRadialReference=function(b){var c=this.element.gradient&&this.renderer.gradients[this.element.gradient];this.element.radialReference=b;c&&c.radAttr&&c.animate(this.renderer.getRadialAttr(b,c.radAttr));return this};a.prototype.setTextPath=function(b,c){var d=this;c=f(!0,{enabled:!0,attributes:{dy:-5,startOffset:"50%",textAnchor:"middle"}},c);var l=this.renderer.url,e=this.text||
this,w=e.textPath,v=c.attributes,a=c.enabled;b=b||w&&w.path;w&&w.undo();b&&a?(c=h(e,"afterModifyTree",function(c){if(b&&a){var f=b.attr("id");f||b.attr("id",f=p());var w={x:0,y:0};B(v.dx)&&(w.dx=v.dx,delete v.dx);B(v.dy)&&(w.dy=v.dy,delete v.dy);e.attr(w);d.attr({transform:""});d.box&&(d.box=d.box.destroy());w=c.nodes.slice(0);c.nodes.length=0;c.nodes[0]={tagName:"textPath",attributes:K(v,{"text-anchor":v.textAnchor,href:"".concat(l,"#").concat(f)}),children:w}}}),e.textPath={path:b,undo:c}):(e.attr({dx:0,
dy:0}),delete e.textPath);this.added&&(e.textCache="",this.renderer.buildText(e));return this};a.prototype.shadow=function(b,c,f){var d=[],e=this.element,w=this.oldShadowOptions,p=this.parentGroup,v=p&&90===p.rotation;p={color:"#000000",offsetX:v?-1:1,offsetY:v?-1:1,opacity:.15,width:3};var a=!1,h;!0===b?h=p:"object"===typeof b&&(h=K(p,b));h&&(h&&w&&l(h,function(b,c){b!==w[c]&&(a=!0)}),a&&this.destroyShadows(),this.oldShadowOptions=h);if(!h)this.destroyShadows();else if(!this.shadows){p=h.opacity/
h.width;var H=v?"translate(".concat(h.offsetY,", ").concat(h.offsetX,")"):"translate(".concat(h.offsetX,", ").concat(h.offsetY,")");for(v=1;v<=h.width;v++){var u=e.cloneNode(!1),k=2*h.width+1-2*v;m(u,{stroke:b.color||"#000000","stroke-opacity":p*v,"stroke-width":k,transform:H,fill:"none"});u.setAttribute("class",(u.getAttribute("class")||"")+" highcharts-shadow");f&&(m(u,"height",Math.max(m(u,"height")-k,0)),u.cutHeight=k);c?c.element.appendChild(u):e.parentNode&&e.parentNode.insertBefore(u,e);d.push(u)}this.shadows=
...
f.parentNode.removeChild(f)}return c};a.prototype.symbolAttr=function(c){var f=this;"x y r start end width height innerR anchorX anchorY clockwise".split(" ").forEach(function(d){f[d]=b(c[d],f[d])});f.attr({d:f.renderer.symbols[f.symbolName](f.x,f.y,f.width,f.height,f)})};a.prototype.textSetter=function(b){b!==this.textStr&&(delete this.textPxLength,this.textStr=b,this.added&&this.renderer.buildText(this))};a.prototype.titleSetter=function(c){var f=this.element,d=f.getElementsByTagName("title")[0]||
q.createElementNS(this.SVG_NS,"title");f.insertBefore?f.insertBefore(d,f.firstChild):f.appendChild(d);d.textContent=String(b(c,"")).replace(/<[^>]*>/g,"").replace(/&lt;/g,"\x3c").replace(/&gt;/g,"\x3e")};a.prototype.toFront=function(){var b=this.element;b.parentNode.appendChild(b);return this};a.prototype.translate=function(b,c){return this.attr({translateX:b,translateY:c})};a.prototype.updateShadows=function(b,c,f){var d=this.shadows;if(d)for(var e=d.length;e--;)f.call(d[e],"height"===b?Math.max(c-
(d[e].cutHeight||0),0):"d"===b?this.d:c,b,d[e])};a.prototype.updateTransform=function(){var c=this.element,f=this.matrix,d=this.rotation;d=void 0===d?0:d;var e=this.scaleX,l=this.scaleY,w=this.translateX,p=this.translateY;w=["translate("+(void 0===w?0:w)+","+(void 0===p?0:p)+")"];B(f)&&w.push("matrix("+f.join(",")+")");d&&w.push("rotate("+d+" "+b(this.rotationOriginX,c.getAttribute("x"),0)+" "+b(this.rotationOriginY,c.getAttribute("y")||0)+")");(B(e)||B(l))&&w.push("scale("+b(e,1)+" "+b(l,1)+")");
w.length&&!(this.text||this).textPath&&c.setAttribute("transform",w.join(" "))};a.prototype.visibilitySetter=function(b,c,f){"inherit"===b?f.removeAttribute(c):this[c]!==b&&f.setAttribute(c,b);this[c]=b};a.prototype.xGetter=function(b){"circle"===this.element.nodeName&&("x"===b?b="cx":"y"===b&&(b="cy"));return this._defaultGetter(b)};a.prototype.zIndexSetter=function(b,c){var f=this.renderer,d=this.parentGroup,e=(d||f).element||f.box,w=this.element;f=e===f.box;var l=!1,p=this.added,a;B(b)?(w.setAttribute("data-z-index",
b),b=+b,this[c]===b&&(p=!1)):B(this[c])&&w.removeAttribute("data-z-index");this[c]=b;if(p){(b=this.zIndex)&&d&&(d.handleZ=!0);c=e.childNodes;for(a=c.length-1;0<=a&&!l;a--){d=c[a];p=d.getAttribute("data-z-index");var h=!B(p);if(d!==w)if(0>b&&h&&!f&&!a)e.insertBefore(w,c[a]),l=!0;else if(v(p)<=b||h&&(!B(b)||0<=b))e.insertBefore(w,c[a+1]||null),l=!0}l||(e.insertBefore(w,c[f?3:0]||null),l=!0)}return l};return a}();a.prototype.strokeSetter=a.prototype.fillSetter;a.prototype.yGetter=a.prototype.xGetter;
a.prototype.matrixSetter=a.prototype.rotationOriginXSetter=a.prototype.rotationOriginYSetter=a.prototype.rotationSetter=a.prototype.scaleXSetter=a.prototype.scaleYSetter=a.prototype.translateXSetter=a.prototype.translateYSetter=a.prototype.verticalAlignSetter=function(b,c){this[c]=b;this.doTransform=!0};"";return a});L(g,"Core/Renderer/RendererRegistry.js",[g["Core/Globals.js"]],function(a){var g;(function(g){g.rendererTypes={};var z;g.getRendererType=function(a){void 0===a&&(a=z);return g.rendererTypes[a]||
g.rendererTypes[z]};g.registerRendererType=function(y,D,J){g.rendererTypes[y]=D;if(!z||J)z=y,a.Renderer=D}})(g||(g={}));return g});L(g,"Core/Renderer/SVG/SVGLabel.js",[g["Core/Renderer/SVG/SVGElement.js"],g["Core/Utilities.js"]],function(a,g){var z=this&&this.__extends||function(){var a=function(e,d){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(d,e){d.__proto__=e}||function(d,e){for(var a in e)Object.prototype.hasOwnProperty.call(e,a)&&(d[a]=e[a])};return a(e,d)};return function(e,
d){function h(){this.constructor=e}if("function"!==typeof d&&null!==d)throw new TypeError("Class extends value "+String(d)+" is not a constructor or null");a(e,d);e.prototype=null===d?Object.create(d):(h.prototype=d.prototype,new h)}}(),E=g.defined,C=g.extend,D=g.isNumber,J=g.merge,t=g.pick,q=g.removeEvent;return function(g){function e(d,a,m,k,r,B,n,q,I,x){var c=g.call(this)||this;c.paddingLeftSetter=c.paddingSetter;c.paddingRightSetter=c.paddingSetter;c.init(d,"g");c.textStr=a;c.x=m;c.y=k;c.anchorX=
B;c.anchorY=n;c.baseline=I;c.className=x;c.addClass("button"===x?"highcharts-no-tooltip":"highcharts-label");x&&c.addClass("highcharts-"+x);c.text=d.text(void 0,0,0,q).attr({zIndex:1});var h;"string"===typeof r&&((h=/^url\((.*?)\)$/.test(r))||c.renderer.symbols[r])&&(c.symbolKey=r);c.bBox=e.emptyBBox;c.padding=3;c.baselineOffset=0;c.needsBox=d.styledMode||h;c.deferredAttr={};c.alignFactor=0;return c}z(e,g);e.prototype.alignSetter=function(d){d={left:0,center:.5,right:1}[d];d!==this.alignFactor&&(this.alignFactor=
d,this.bBox&&D(this.xSetting)&&this.attr({x:this.xSetting}))};e.prototype.anchorXSetter=function(d,e){this.anchorX=d;this.boxAttr(e,Math.round(d)-this.getCrispAdjust()-this.xSetting)};e.prototype.anchorYSetter=function(d,e){this.anchorY=d;this.boxAttr(e,d-this.ySetting)};e.prototype.boxAttr=function(d,e){this.box?this.box.attr(d,e):this.deferredAttr[d]=e};e.prototype.css=function(d){if(d){var h={};d=J(d);e.textProps.forEach(function(e){"undefined"!==typeof d[e]&&(h[e]=d[e],delete d[e])});this.text.css(h);
"fontSize"in h||"fontWeight"in h?this.updateTextPadding():("width"in h||"textOverflow"in h)&&this.updateBoxSize()}return a.prototype.css.call(this,d)};e.prototype.destroy=function(){q(this.element,"mouseenter");q(this.element,"mouseleave");this.text&&this.text.destroy();this.box&&(this.box=this.box.destroy());a.prototype.destroy.call(this)};e.prototype.fillSetter=function(d,e){d&&(this.needsBox=!0);this.fill=d;this.boxAttr(e,d)};e.prototype.getBBox=function(){this.textStr&&0===this.bBox.width&&0===
this.bBox.height&&this.updateBoxSize();var d=this.padding,e=t(this.paddingLeft,d);return{width:this.width,height:this.height,x:this.bBox.x-e,y:this.bBox.y-d}};e.prototype.getCrispAdjust=function(){return this.renderer.styledMode&&this.box?this.box.strokeWidth()%2/2:(this["stroke-width"]?parseInt(this["stroke-width"],10):0)%2/2};e.prototype.heightSetter=function(d){this.heightSetting=d};e.prototype.onAdd=function(){this.text.add(this);this.attr({text:t(this.textStr,""),x:this.x||0,y:this.y||0});this.box&&
E(this.anchorX)&&this.attr({anchorX:this.anchorX,anchorY:this.anchorY})};e.prototype.paddingSetter=function(d,e){D(d)?d!==this[e]&&(this[e]=d,this.updateTextPadding()):this[e]=void 0};e.prototype.rSetter=function(d,e){this.boxAttr(e,d)};e.prototype.shadow=function(d){d&&!this.renderer.styledMode&&(this.updateBoxSize(),this.box&&this.box.shadow(d));return this};e.prototype.strokeSetter=function(d,e){this.stroke=d;this.boxAttr(e,d)};e.prototype["stroke-widthSetter"]=function(d,e){d&&(this.needsBox=
!0);this["stroke-width"]=d;this.boxAttr(e,d)};e.prototype["text-alignSetter"]=function(d){this.textAlign=d};e.prototype.textSetter=function(d){"undefined"!==typeof d&&this.text.attr({text:d});this.updateTextPadding()};e.prototype.updateBoxSize=function(){var d=this.text,a=d.element.style,m={},k=this.padding,r=this.bBox=D(this.widthSetting)&&D(this.heightSetting)&&!this.textAlign||!E(d.textStr)?e.emptyBBox:d.getBBox();this.width=this.getPaddedWidth();this.height=(this.heightSetting||r.height||0)+2*
k;a=this.renderer.fontMetrics(a&&a.fontSize,d);this.baselineOffset=k+Math.min((this.text.firstLineMetrics||a).b,r.height||Infinity);this.heightSetting&&(this.baselineOffset+=(this.heightSetting-a.h)/2);this.needsBox&&!d.textPath&&(this.box||(d=this.box=this.symbolKey?this.renderer.symbol(this.symbolKey):this.renderer.rect(),d.addClass(("button"===this.className?"":"highcharts-label-box")+(this.className?" highcharts-"+this.className+"-box":"")),d.add(this)),d=this.getCrispAdjust(),m.x=d,m.y=(this.baseline?
-this.baselineOffset:0)+d,m.width=Math.round(this.width),m.height=Math.round(this.height),this.box.attr(C(m,this.deferredAttr)),this.deferredAttr={})};e.prototype.updateTextPadding=function(){var d=this.text;if(!d.textPath){this.updateBoxSize();var e=this.baseline?0:this.baselineOffset,a=t(this.paddingLeft,this.padding);E(this.widthSetting)&&this.bBox&&("center"===this.textAlign||"right"===this.textAlign)&&(a+={center:.5,right:1}[this.textAlign]*(this.widthSetting-this.bBox.width));if(a!==d.x||e!==
d.y)d.attr("x",a),d.hasBoxWidthChanged&&(this.bBox=d.getBBox(!0)),"undefined"!==typeof e&&d.attr("y",e);d.x=a;d.y=e}};e.prototype.widthSetter=function(d){this.widthSetting=D(d)?d:void 0};e.prototype.getPaddedWidth=function(){var d=this.padding,e=t(this.paddingLeft,d);d=t(this.paddingRight,d);return(this.widthSetting||this.bBox.width||0)+e+d};e.prototype.xSetter=function(d){this.x=d;this.alignFactor&&(d-=this.alignFactor*this.getPaddedWidth(),this["forceAnimate:x"]=!0);this.xSetting=Math.round(d);
this.attr("translateX",this.xSetting)};e.prototype.ySetter=function(d){this.ySetting=this.y=Math.round(d);this.attr("translateY",this.ySetting)};e.emptyBBox={width:0,height:0,x:0,y:0};e.textProps="color direction fontFamily fontSize fontStyle fontWeight lineHeight textAlign textDecoration textOutline textOverflow width".split(" ");return e}(a)});L(g,"Core/Renderer/SVG/Symbols.js",[g["Core/Utilities.js"]],function(a){function g(a,g,n,e,d){var h=[];if(d){var m=d.start||0,k=J(d.r,n);n=J(d.r,e||n);var r=
(d.end||0)-.001;e=d.innerR;var B=J(d.open,.001>Math.abs((d.end||0)-m-2*Math.PI)),G=Math.cos(m),q=Math.sin(m),I=Math.cos(r),x=Math.sin(r);m=J(d.longArc,.001>r-m-Math.PI?0:1);h.push(["M",a+k*G,g+n*q],["A",k,n,0,m,J(d.clockwise,1),a+k*I,g+n*x]);C(e)&&h.push(B?["M",a+e*I,g+e*x]:["L",a+e*I,g+e*x],["A",e,e,0,m,C(d.clockwise)?1-d.clockwise:0,a+e*G,g+e*q]);B||h.push(["Z"])}return h}function y(a,g,n,e,d){return d&&d.r?E(a,g,n,e,d):[["M",a,g],["L",a+n,g],["L",a+n,g+e],["L",a,g+e],["Z"]]}function E(a,g,n,e,
d){d=d&&d.r||0;return[["M",a+d,g],["L",a+n-d,g],["C",a+n,g,a+n,g,a+n,g+d],["L",a+n,g+e-d],["C",a+n,g+e,a+n,g+e,a+n-d,g+e],["L",a+d,g+e],["C",a,g+e,a,g+e,a,g+e-d],["L",a,g+d],["C",a,g,a,g,a+d,g]]}var C=a.defined,D=a.isNumber,J=a.pick;return{arc:g,callout:function(a,g,n,e,d){var h=Math.min(d&&d.r||0,n,e),m=h+6,k=d&&d.anchorX;d=d&&d.anchorY||0;var r=E(a,g,n,e,{r:h});if(!D(k))return r;a+k>=n?d>g+m&&d<g+e-m?r.splice(3,1,["L",a+n,d-6],["L",a+n+6,d],["L",a+n,d+6],["L",a+n,g+e-h]):r.splice(3,1,["L",a+n,e/
2],["L",k,d],["L",a+n,e/2],["L",a+n,g+e-h]):0>=a+k?d>g+m&&d<g+e-m?r.splice(7,1,["L",a,d+6],["L",a-6,d],["L",a,d-6],["L",a,g+h]):r.splice(7,1,["L",a,e/2],["L",k,d],["L",a,e/2],["L",a,g+h]):d&&d>e&&k>a+m&&k<a+n-m?r.splice(5,1,["L",k+6,g+e],["L",k,g+e+6],["L",k-6,g+e],["L",a+h,g+e]):d&&0>d&&k>a+m&&k<a+n-m&&r.splice(1,1,["L",k-6,g],["L",k,g-6],["L",k+6,g],["L",n-h,g]);return r},circle:function(a,q,n,e){return g(a+n/2,q+e/2,n/2,e/2,{start:.5*Math.PI,end:2.5*Math.PI,open:!1})},diamond:function(a,g,n,e){return[["M",
a+n/2,g],["L",a+n,g+e/2],["L",a+n/2,g+e],["L",a,g+e/2],["Z"]]},rect:y,roundedRect:E,square:y,triangle:function(a,g,n,e){return[["M",a+n/2,g],["L",a+n,g+e],["L",a,g+e],["Z"]]},"triangle-down":function(a,g,n,e){return[["M",a,g],["L",a+n,g],["L",a+n/2,g+e],["Z"]]}}});L(g,"Core/Renderer/SVG/TextBuilder.js",[g["Core/Renderer/HTML/AST.js"],g["Core/Globals.js"],g["Core/Utilities.js"]],function(a,g,y){var z=g.doc,C=g.SVG_NS,D=g.win,J=y.attr,t=y.extend,q=y.fireEvent,n=y.isString,e=y.objectEach,d=y.pick;return function(){function h(d){var e=
d.styles;this.renderer=d.renderer;this.svgElement=d;this.width=d.textWidth;this.textLineHeight=e&&e.lineHeight;this.textOutline=e&&e.textOutline;this.ellipsis=!(!e||"ellipsis"!==e.textOverflow);this.noWrap=!(!e||"nowrap"!==e.whiteSpace);this.fontSize=e&&e.fontSize}h.prototype.buildSVG=function(){var e=this.svgElement,h=e.element,r=e.renderer,g=d(e.textStr,"").toString(),G=-1!==g.indexOf("\x3c"),K=h.childNodes;r=this.width&&!e.added&&r.box;var I=/<br.*?>/g,x=[g,this.ellipsis,this.noWrap,this.textLineHeight,
this.textOutline,this.fontSize,this.width].join();if(x!==e.textCache){e.textCache=x;delete e.actualWidth;for(x=K.length;x--;)h.removeChild(K[x]);G||this.ellipsis||this.width||e.textPath||-1!==g.indexOf(" ")&&(!this.noWrap||I.test(g))?""!==g&&(r&&r.appendChild(h),g=new a(g),this.modifyTree(g.nodes),g.addToDOM(h),this.modifyDOM(),this.ellipsis&&-1!==(h.textContent||"").indexOf("\u2026")&&e.attr("title",this.unescapeEntities(e.textStr||"",["\x26lt;","\x26gt;"])),r&&r.removeChild(h)):h.appendChild(z.createTextNode(this.unescapeEntities(g)));
n(this.textOutline)&&e.applyTextOutline&&e.applyTextOutline(this.textOutline)}};h.prototype.modifyDOM=function(){var d=this,e=this.svgElement,a=J(e.element,"x");e.firstLineMetrics=void 0;for(var h;h=e.element.firstChild;)if(/^[\s\u200B]*$/.test(h.textContent||" "))e.element.removeChild(h);else break;[].forEach.call(e.element.querySelectorAll("tspan.highcharts-br"),function(h,c){h.nextSibling&&h.previousSibling&&(0===c&&1===h.previousSibling.nodeType&&(e.firstLineMetrics=e.renderer.fontMetrics(void 0,
h.previousSibling)),J(h,{dy:d.getLineHeight(h.nextSibling),x:a}))});var g=this.width||0;if(g){var n=function(h,c){var u=h.textContent||"",f=u.replace(/([^\^])-/g,"$1- ").split(" "),l=!d.noWrap&&(1<f.length||1<e.element.childNodes.length),b=d.getLineHeight(c),v=0,A=e.actualWidth;if(d.ellipsis)u&&d.truncate(h,u,void 0,0,Math.max(0,g-parseInt(d.fontSize||12,10)),function(b,c){return b.substring(0,c)+"\u2026"});else if(l){u=[];for(l=[];c.firstChild&&c.firstChild!==h;)l.push(c.firstChild),c.removeChild(c.firstChild);
for(;f.length;)f.length&&!d.noWrap&&0<v&&(u.push(h.textContent||""),h.textContent=f.join(" ").replace(/- /g,"-")),d.truncate(h,void 0,f,0===v?A||0:0,g,function(b,c){return f.slice(0,c).join(" ").replace(/- /g,"-")}),A=e.actualWidth,v++;l.forEach(function(b){c.insertBefore(b,h)});u.forEach(function(f){c.insertBefore(z.createTextNode(f),h);f=z.createElementNS(C,"tspan");f.textContent="\u200b";J(f,{dy:b,x:a});c.insertBefore(f,h)})}},I=function(d){[].slice.call(d.childNodes).forEach(function(c){c.nodeType===
D.Node.TEXT_NODE?n(c,d):(-1!==c.className.baseVal.indexOf("highcharts-br")&&(e.actualWidth=0),I(c))})};I(e.element)}};h.prototype.getLineHeight=function(d){var e;d=d.nodeType===D.Node.TEXT_NODE?d.parentElement:d;this.renderer.styledMode||(e=d&&/(px|em)$/.test(d.style.fontSize)?d.style.fontSize:this.fontSize||this.renderer.style.fontSize||12);return this.textLineHeight?parseInt(this.textLineHeight.toString(),10):this.renderer.fontMetrics(e,d||this.svgElement.element).h};h.prototype.modifyTree=function(d){var e=
this,a=function(h,k){var r=h.attributes;r=void 0===r?{}:r;var g=h.children,m=h.style;m=void 0===m?{}:m;var c=h.tagName,u=e.renderer.styledMode;if("b"===c||"strong"===c)u?r["class"]="highcharts-strong":m.fontWeight="bold";else if("i"===c||"em"===c)u?r["class"]="highcharts-emphasized":m.fontStyle="italic";m&&m.color&&(m.fill=m.color);"br"===c?(r["class"]="highcharts-br",h.textContent="\u200b",(k=d[k+1])&&k.textContent&&(k.textContent=k.textContent.replace(/^ +/gm,""))):"a"===c&&g&&g.some(function(c){return"#text"===
c.tagName})&&(h.children=[{children:g,tagName:"tspan"}]);"#text"!==c&&"a"!==c&&(h.tagName="tspan");t(h,{attributes:r,style:m});g&&g.filter(function(c){return"#text"!==c.tagName}).forEach(a)};d.forEach(a);q(this.svgElement,"afterModifyTree",{nodes:d})};h.prototype.truncate=function(d,e,a,h,g,n){var k=this.svgElement,m=k.renderer,c=k.rotation,u=[],f=a?1:0,l=(e||a||"").length,b=l,v,A=function(b,c){c=c||b;var f=d.parentNode;if(f&&"undefined"===typeof u[c])if(f.getSubStringLength)try{u[c]=h+f.getSubStringLength(0,
a?c+1:c)}catch(Q){""}else m.getSpanWidth&&(d.textContent=n(e||a,b),u[c]=h+m.getSpanWidth(k,d));return u[c]};k.rotation=0;var p=A(d.textContent.length);if(h+p>g){for(;f<=l;)b=Math.ceil((f+l)/2),a&&(v=n(a,b)),p=A(b,v&&v.length-1),f===l?f=l+1:p>g?l=b-1:f=b;0===l?d.textContent="":e&&l===e.length-1||(d.textContent=v||n(e||a,b))}a&&a.splice(0,b);k.actualWidth=p;k.rotation=c};h.prototype.unescapeEntities=function(d,a){e(this.renderer.escapes,function(e,h){a&&-1!==a.indexOf(e)||(d=d.toString().replace(new RegExp(e,
"g"),h))});return d};return h}()});L(g,"Core/Renderer/SVG/SVGRenderer.js",[g["Core/Renderer/HTML/AST.js"],g["Core/Color/Color.js"],g["Core/Globals.js"],g["Core/Renderer/RendererRegistry.js"],g["Core/Renderer/SVG/SVGElement.js"],g["Core/Renderer/SVG/SVGLabel.js"],g["Core/Renderer/SVG/Symbols.js"],g["Core/Renderer/SVG/TextBuilder.js"],g["Core/Utilities.js"]],function(a,g,y,E,C,D,J,t,q){var n=y.charts,e=y.deg2rad,d=y.doc,h=y.isFirefox,m=y.isMS,k=y.isWebKit,r=y.noop,B=y.SVG_NS,G=y.symbolSizes,K=y.win,
I=q.addEvent,x=q.attr,c=q.createElement,u=q.css,f=q.defined,l=q.destroyObjectProperties,b=q.extend,v=q.isArray,A=q.isNumber,p=q.isObject,M=q.isString,F=q.merge,N=q.pick,Q=q.pInt,z=q.uniqueKey,Y;y=function(){function w(b,c,f,d,e,w,a){this.width=this.url=this.style=this.isSVG=this.imgCount=this.height=this.gradients=this.globalAnimation=this.defs=this.chartIndex=this.cacheKeys=this.cache=this.boxWrapper=this.box=this.alignedObjects=void 0;this.init(b,c,f,d,e,w,a)}w.prototype.init=function(b,c,f,e,w,
a,l){var H=this.createElement("svg").attr({version:"1.1","class":"highcharts-root"}),p=H.element;l||H.css(this.getStyle(e));b.appendChild(p);x(b,"dir","ltr");-1===b.innerHTML.indexOf("xmlns")&&x(p,"xmlns",this.SVG_NS);this.isSVG=!0;this.box=p;this.boxWrapper=H;this.alignedObjects=[];this.url=this.getReferenceURL();this.createElement("desc").add().element.appendChild(d.createTextNode("Created with Highcharts 10.3.3"));this.defs=this.createElement("defs").add();this.allowHTML=a;this.forExport=w;this.styledMode=
l;this.gradients={};this.cache={};this.cacheKeys=[];this.imgCount=0;this.setSize(c,f,!1);var v;h&&b.getBoundingClientRect&&(c=function(){u(b,{left:0,top:0});v=b.getBoundingClientRect();u(b,{left:Math.ceil(v.left)-v.left+"px",top:Math.ceil(v.top)-v.top+"px"})},c(),this.unSubPixelFix=I(K,"resize",c))};w.prototype.definition=function(b){return(new a([b])).addToDOM(this.defs.element)};w.prototype.getReferenceURL=function(){if((h||k)&&d.getElementsByTagName("base").length){if(!f(Y)){var b=z();b=(new a([{tagName:"svg",
...
"\\$1").replace(/ /g,"%20")}return""};w.prototype.getStyle=function(c){return this.style=b({fontFamily:'"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif',fontSize:"12px"},c)};w.prototype.setStyle=function(b){this.boxWrapper.css(this.getStyle(b))};w.prototype.isHidden=function(){return!this.boxWrapper.getBBox().width};w.prototype.destroy=function(){var b=this.defs;this.box=null;this.boxWrapper=this.boxWrapper.destroy();l(this.gradients||{});this.gradients=null;b&&(this.defs=b.destroy());
this.unSubPixelFix&&this.unSubPixelFix();return this.alignedObjects=null};w.prototype.createElement=function(b){var c=new this.Element;c.init(this,b);return c};w.prototype.getRadialAttr=function(b,c){return{cx:b[0]-b[2]/2+(c.cx||0)*b[2],cy:b[1]-b[2]/2+(c.cy||0)*b[2],r:(c.r||0)*b[2]}};w.prototype.buildText=function(b){(new t(b)).buildSVG()};w.prototype.getContrast=function(b){b=g.parse(b).rgba.map(function(b){b/=255;return.03928>=b?b/12.92:Math.pow((b+.055)/1.055,2.4)});b=.2126*b[0]+.7152*b[1]+.0722*
b[2];return 1.05/(b+.05)>(b+.05)/.05?"#FFFFFF":"#000000"};w.prototype.button=function(c,f,d,e,w,l,v,h,u,A){void 0===w&&(w={});var H=this.label(c,f,d,u,void 0,void 0,A,void 0,"button"),k=this.styledMode;c=w.states||{};var O=0;w=F(w);delete w.states;var g=F({color:"#333333",cursor:"pointer",fontWeight:"normal"},w.style);delete w.style;var r=a.filterUserAttributes(w);H.attr(F({padding:8,r:2},r));if(!k){r=F({fill:"#f7f7f7",stroke:"#cccccc","stroke-width":1},r);l=F(r,{fill:"#e6e6e6"},a.filterUserAttributes(l||
c.hover||{}));var T=l.style;delete l.style;v=F(r,{fill:"#e6ebf5",style:{color:"#000000",fontWeight:"bold"}},a.filterUserAttributes(v||c.select||{}));var P=v.style;delete v.style;h=F(r,{style:{color:"#cccccc"}},a.filterUserAttributes(h||c.disabled||{}));var x=h.style;delete h.style}I(H.element,m?"mouseover":"mouseenter",function(){3!==O&&H.setState(1)});I(H.element,m?"mouseout":"mouseleave",function(){3!==O&&H.setState(O)});H.setState=function(b){1!==b&&(H.state=O=b);H.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-"+
["normal","hover","pressed","disabled"][b||0]);k||(H.attr([r,l,v,h][b||0]),b=[g,T,P,x][b||0],p(b)&&H.css(b))};k||(H.attr(r).css(b({cursor:"default"},g)),A&&H.text.css({pointerEvents:"none"}));return H.on("touchstart",function(b){return b.stopPropagation()}).on("click",function(b){3!==O&&e.call(H,b)})};w.prototype.crispLine=function(b,c,d){void 0===d&&(d="round");var e=b[0],w=b[1];f(e[1])&&e[1]===w[1]&&(e[1]=w[1]=Math[d](e[1])-c%2/2);f(e[2])&&e[2]===w[2]&&(e[2]=w[2]=Math[d](e[2])+c%2/2);return b};
w.prototype.path=function(c){var f=this.styledMode?{}:{fill:"none"};v(c)?f.d=c:p(c)&&b(f,c);return this.createElement("path").attr(f)};w.prototype.circle=function(b,c,f){b=p(b)?b:"undefined"===typeof b?{}:{x:b,y:c,r:f};c=this.createElement("circle");c.xSetter=c.ySetter=function(b,c,f){f.setAttribute("c"+c,b)};return c.attr(b)};w.prototype.arc=function(b,c,f,d,e,w){p(b)?(d=b,c=d.y,f=d.r,b=d.x):d={innerR:d,start:e,end:w};b=this.symbol("arc",b,c,f,f,d);b.r=f;return b};w.prototype.rect=function(b,c,f,
d,e,w){e=p(b)?b.r:e;var a=this.createElement("rect");b=p(b)?b:"undefined"===typeof b?{}:{x:b,y:c,width:Math.max(f,0),height:Math.max(d,0)};this.styledMode||("undefined"!==typeof w&&(b["stroke-width"]=w,b=a.crisp(b)),b.fill="none");e&&(b.r=e);a.rSetter=function(b,c,f){a.r=b;x(f,{rx:b,ry:b})};a.rGetter=function(){return a.r||0};return a.attr(b)};w.prototype.setSize=function(b,c,f){this.width=b;this.height=c;this.boxWrapper.animate({width:b,height:c},{step:function(){this.attr({viewBox:"0 0 "+this.attr("width")+
" "+this.attr("height")})},duration:N(f,!0)?void 0:0});this.alignElements()};w.prototype.g=function(b){var c=this.createElement("g");return b?c.attr({"class":"highcharts-"+b}):c};w.prototype.image=function(b,c,f,d,e,w){var a={preserveAspectRatio:"none"},l=function(b,c){b.setAttributeNS?b.setAttributeNS("http://www.w3.org/1999/xlink","href",c):b.setAttribute("hc-svg-href",c)};A(c)&&(a.x=c);A(f)&&(a.y=f);A(d)&&(a.width=d);A(e)&&(a.height=e);var H=this.createElement("image").attr(a);c=function(c){l(H.element,
b);w.call(H,c)};w?(l(H.element,"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"),f=new K.Image,I(f,"load",c),f.src=b,f.complete&&c({})):l(H.element,b);return H};w.prototype.symbol=function(e,w,a,l,H,p){var v=this,h=/^url\((.*?)\)$/,A=h.test(e),k=!A&&(this.symbols[e]?e:"circle"),g=k&&this.symbols[k],r;if(g){"number"===typeof w&&(r=g.call(this.symbols,Math.round(w||0),Math.round(a||0),l||0,H||0,p));var m=this.path(r);v.styledMode||m.attr("fill","none");b(m,{symbolName:k||
void 0,x:w,y:a,width:l,height:H});p&&b(m,p)}else if(A){var P=e.match(h)[1],T=m=this.image(P);T.imgwidth=N(G[P]&&G[P].width,p&&p.width);T.imgheight=N(G[P]&&G[P].height,p&&p.height);["width","height"].forEach(function(b){T[b+"Setter"]=function(b,c){this[c]=b;b=this.alignByTranslate;var d=this.element,e=this.width,w=this.height,a=this.imgwidth,l=this.imgheight,H=this["img"+c];if(f(H)){var v=1;p&&"within"===p.backgroundSize&&e&&w?(v=Math.min(e/a,w/l),H=Math.round(H*v),x(d,{width:Math.round(a*v),height:Math.round(l*
v)})):d&&d.setAttribute(c,H);b||this.translate(((e||0)-H*v)/2,((w||0)-H*v)/2)}}});f(w)&&T.attr({x:w,y:a});T.isImg=!0;f(T.imgwidth)&&f(T.imgheight)?T.attr({width:T.width,height:T.height}):(T.attr({width:0,height:0}),c("img",{onload:function(){var b=n[v.chartIndex];0===this.width&&(u(this,{position:"absolute",top:"-999em"}),d.body.appendChild(this));G[P]={width:this.width,height:this.height};T.imgwidth=this.width;T.imgheight=this.height;T.element&&T.attr({width:T.width,height:T.height});this.parentNode&&
this.parentNode.removeChild(this);v.imgCount--;if(!v.imgCount&&b&&!b.hasLoaded)b.onload()},src:P}),this.imgCount++)}return m};w.prototype.clipRect=function(b,c,f,d){var e=z()+"-",w=this.createElement("clipPath").attr({id:e}).add(this.defs);b=this.rect(b,c,f,d,0).add(w);b.id=e;b.clipPath=w;b.count=0;return b};w.prototype.text=function(b,c,d,e){var w={};if(e&&(this.allowHTML||!this.forExport))return this.html(b,c,d);w.x=Math.round(c||0);d&&(w.y=Math.round(d));f(b)&&(w.text=b);b=this.createElement("text").attr(w);
if(!e||this.forExport&&!this.allowHTML)b.xSetter=function(b,c,f){for(var d=f.getElementsByTagName("tspan"),e=f.getAttribute(c),w=0,a;w<d.length;w++)a=d[w],a.getAttribute(c)===e&&a.setAttribute(c,b);f.setAttribute(c,b)};return b};w.prototype.fontMetrics=function(b,c){b=!this.styledMode&&/px/.test(b)||!K.getComputedStyle?b||c&&c.style&&c.style.fontSize||this.style&&this.style.fontSize:c&&C.prototype.getStyle.call(c,"font-size");b=/px/.test(b)?Q(b):12;c=24>b?b+3:Math.round(1.2*b);return{h:c,b:Math.round(.8*
c),f:b}};w.prototype.rotCorr=function(b,c,f){var d=b;c&&f&&(d=Math.max(d*Math.cos(c*e),4));return{x:-b/3*Math.sin(c*e),y:d}};w.prototype.pathToSegments=function(b){for(var c=[],f=[],d={A:8,C:7,H:2,L:3,M:3,Q:5,S:5,T:3,V:2},e=0;e<b.length;e++)M(f[0])&&A(b[e])&&f.length===d[f[0].toUpperCase()]&&b.splice(e,0,f[0].replace("M","L").replace("m","l")),"string"===typeof b[e]&&(f.length&&c.push(f.slice(0)),f.length=0),f.push(b[e]);c.push(f.slice(0));return c};w.prototype.label=function(b,c,f,d,e,w,a,l,p){return new D(this,
b,c,f,d,e,w,a,l,p)};w.prototype.alignElements=function(){this.alignedObjects.forEach(function(b){return b.align()})};return w}();b(y.prototype,{Element:C,SVG_NS:B,escapes:{"\x26":"\x26amp;","\x3c":"\x26lt;","\x3e":"\x26gt;","'":"\x26#39;",'"':"\x26quot;"},symbols:J,draw:r});E.registerRendererType("svg",y,!0);"";return y});L(g,"Core/Renderer/HTML/HTMLElement.js",[g["Core/Globals.js"],g["Core/Renderer/SVG/SVGElement.js"],g["Core/Utilities.js"]],function(a,g,y){var z=this&&this.__extends||function(){var d=
function(e,a){d=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(d,e){d.__proto__=e}||function(d,e){for(var a in e)Object.prototype.hasOwnProperty.call(e,a)&&(d[a]=e[a])};return d(e,a)};return function(e,a){function h(){this.constructor=e}if("function"!==typeof a&&null!==a)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");d(e,a);e.prototype=null===a?Object.create(a):(h.prototype=a.prototype,new h)}}(),C=a.isFirefox,D=a.isMS,J=a.isWebKit,t=a.win,q=
y.css,n=y.defined,e=y.extend,d=y.pick,h=y.pInt;return function(a){function k(){return null!==a&&a.apply(this,arguments)||this}z(k,a);k.compose=function(d){if(-1===k.composedClasses.indexOf(d)){k.composedClasses.push(d);var e=k.prototype,a=d.prototype;a.getSpanCorrection=e.getSpanCorrection;a.htmlCss=e.htmlCss;a.htmlGetBBox=e.htmlGetBBox;a.htmlUpdateTransform=e.htmlUpdateTransform;a.setSpanRotation=e.setSpanRotation}return d};k.prototype.getSpanCorrection=function(d,e,a){this.xCorr=-d*a;this.yCorr=
-e};k.prototype.htmlCss=function(a){var h="SPAN"===this.element.tagName&&a&&"width"in a,k=d(h&&a.width,void 0);if(h){delete a.width;this.textWidth=k;var g=!0}a&&"ellipsis"===a.textOverflow&&(a.whiteSpace="nowrap",a.overflow="hidden");this.styles=e(this.styles,a);q(this.element,a);g&&this.htmlUpdateTransform();return this};k.prototype.htmlGetBBox=function(){var d=this.element;return{x:d.offsetLeft,y:d.offsetTop,width:d.offsetWidth,height:d.offsetHeight}};k.prototype.htmlUpdateTransform=function(){if(this.added){var d=
this.renderer,e=this.element,a=this.translateX||0,k=this.translateY||0,g=this.x||0,m=this.y||0,c=this.textAlign||"left",u={left:0,center:.5,right:1}[c],f=this.styles;f=f&&f.whiteSpace;q(e,{marginLeft:a,marginTop:k});!d.styledMode&&this.shadows&&this.shadows.forEach(function(b){q(b,{marginLeft:a+1,marginTop:k+1})});this.inverted&&[].forEach.call(e.childNodes,function(b){d.invertChild(b,e)});if("SPAN"===e.tagName){var l=this.rotation,b=this.textWidth&&h(this.textWidth),v=[l,c,e.innerHTML,this.textWidth,
this.textAlign].join(),A=void 0;A=!1;if(b!==this.oldTextWidth){if(this.textPxLength)var p=this.textPxLength;else q(e,{width:"",whiteSpace:f||"nowrap"}),p=e.offsetWidth;(b>this.oldTextWidth||p>b)&&(/[ \-]/.test(e.textContent||e.innerText)||"ellipsis"===e.style.textOverflow)&&(q(e,{width:p>b||l?b+"px":"auto",display:"block",whiteSpace:f||"normal"}),this.oldTextWidth=b,A=!0)}this.hasBoxWidthChanged=A;v!==this.cTT&&(A=d.fontMetrics(e.style.fontSize,e).b,!n(l)||l===(this.oldRotation||0)&&c===this.oldAlign||
this.setSpanRotation(l,u,A),this.getSpanCorrection(!n(l)&&this.textPxLength||e.offsetWidth,A,u,l,c));q(e,{left:g+(this.xCorr||0)+"px",top:m+(this.yCorr||0)+"px"});this.cTT=v;this.oldRotation=l;this.oldAlign=c}}else this.alignOnAdd=!0};k.prototype.setSpanRotation=function(d,e,a){var h={},k=D&&!/Edge/.test(t.navigator.userAgent)?"-ms-transform":J?"-webkit-transform":C?"MozTransform":t.opera?"-o-transform":void 0;k&&(h[k]=h.transform="rotate("+d+"deg)",h[k+(C?"Origin":"-origin")]=h.transformOrigin=100*
e+"% "+a+"px",q(this.element,h))};k.composedClasses=[];return k}(g)});L(g,"Core/Renderer/HTML/HTMLRenderer.js",[g["Core/Renderer/HTML/AST.js"],g["Core/Renderer/SVG/SVGElement.js"],g["Core/Renderer/SVG/SVGRenderer.js"],g["Core/Utilities.js"]],function(a,g,y,E){var z=this&&this.__extends||function(){var a=function(e,d){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(d,e){d.__proto__=e}||function(d,e){for(var a in e)Object.prototype.hasOwnProperty.call(e,a)&&(d[a]=e[a])};return a(e,
d)};return function(e,d){function h(){this.constructor=e}if("function"!==typeof d&&null!==d)throw new TypeError("Class extends value "+String(d)+" is not a constructor or null");a(e,d);e.prototype=null===d?Object.create(d):(h.prototype=d.prototype,new h)}}(),D=E.attr,J=E.createElement,t=E.extend,q=E.pick;return function(n){function e(){return null!==n&&n.apply(this,arguments)||this}z(e,n);e.compose=function(d){-1===e.composedClasses.indexOf(d)&&(e.composedClasses.push(d),d.prototype.html=e.prototype.html);
return d};e.prototype.html=function(d,e,m){var h=this.createElement("span"),r=h.element,n=h.renderer,G=n.isSVG,K=function(d,e){["opacity","visibility"].forEach(function(c){d[c+"Setter"]=function(a,f,l){var b=d.div?d.div.style:e;g.prototype[c+"Setter"].call(this,a,f,l);b&&(b[f]=a)}});d.addedSetters=!0};h.textSetter=function(d){d!==this.textStr&&(delete this.bBox,delete this.oldTextWidth,a.setElementHTML(this.element,q(d,"")),this.textStr=d,h.doTransform=!0)};G&&K(h,h.element.style);h.xSetter=h.ySetter=
h.alignSetter=h.rotationSetter=function(d,e){"align"===e?h.alignValue=h.textAlign=d:h[e]=d;h.doTransform=!0};h.afterSetters=function(){this.doTransform&&(this.htmlUpdateTransform(),this.doTransform=!1)};h.attr({text:d,x:Math.round(e),y:Math.round(m)}).css({position:"absolute"});n.styledMode||h.css({fontFamily:this.style.fontFamily,fontSize:this.style.fontSize});r.style.whiteSpace="nowrap";h.css=h.htmlCss;G&&(h.add=function(d){var e=n.box.parentNode,c=[];if(this.parentGroup=d){var a=d.div;if(!a){for(;d;)c.push(d),
d=d.parentGroup;c.reverse().forEach(function(f){function d(b,c){f[c]=b;"translateX"===c?u.left=b+"px":u.top=b+"px";f.doTransform=!0}var b=D(f.element,"class"),v=f.styles||{};a=f.div=f.div||J("div",b?{className:b}:void 0,{position:"absolute",left:(f.translateX||0)+"px",top:(f.translateY||0)+"px",display:f.display,opacity:f.opacity,cursor:v.cursor,pointerEvents:v.pointerEvents,visibility:f.visibility},a||e);var u=a.style;t(f,{classSetter:function(b){return function(c){this.element.setAttribute("class",
c);b.className=c}}(a),on:function(){c[0].div&&h.on.apply({element:c[0].div,onEvents:f.onEvents},arguments);return f},translateXSetter:d,translateYSetter:d});f.addedSetters||K(f)})}}else a=e;a.appendChild(r);h.added=!0;h.alignOnAdd&&h.htmlUpdateTransform();return h});return h};e.composedClasses=[];return e}(y)});L(g,"Core/Axis/AxisDefaults.js",[],function(){var a;(function(a){a.defaultXAxisOptions={alignTicks:!0,allowDecimals:void 0,panningEnabled:!0,zIndex:2,zoomEnabled:!0,dateTimeLabelFormats:{millisecond:{main:"%H:%M:%S.%L",
...
lineColor:"#ccd6eb",lineWidth:1,gridLineColor:"#e6e6e6",gridLineWidth:void 0,tickColor:"#ccd6eb"};a.defaultYAxisOptions={reversedStacks:!0,endOnTick:!0,maxPadding:.05,minPadding:.05,tickPixelInterval:72,showLastLabel:!0,labels:{x:-8},startOnTick:!0,title:{rotation:270,text:"Values"},stackLabels:{animation:{},allowOverlap:!1,enabled:!1,crop:!0,overflow:"justify",formatter:function(){var a=this.axis.chart.numberFormatter;return a(this.total||0,-1)},style:{color:"#000000",fontSize:"11px",fontWeight:"bold",
textOutline:"1px contrast"}},gridLineWidth:1,lineWidth:0};a.defaultLeftAxisOptions={labels:{x:-15},title:{rotation:270}};a.defaultRightAxisOptions={labels:{x:15},title:{rotation:90}};a.defaultBottomAxisOptions={labels:{autoRotation:[-45],x:0},margin:15,title:{rotation:0}};a.defaultTopAxisOptions={labels:{autoRotation:[-45],x:0},margin:15,title:{rotation:0}}})(a||(a={}));return a});L(g,"Core/Foundation.js",[g["Core/Utilities.js"]],function(a){var g=a.addEvent,y=a.isFunction,E=a.objectEach,C=a.removeEvent,
D;(function(a){a.registerEventOptions=function(a,q){a.eventOptions=a.eventOptions||{};E(q.events,function(n,e){a.eventOptions[e]!==n&&(a.eventOptions[e]&&(C(a,e,a.eventOptions[e]),delete a.eventOptions[e]),y(n)&&(a.eventOptions[e]=n,g(a,e,n)))})}})(D||(D={}));return D});L(g,"Core/Axis/Tick.js",[g["Core/FormatUtilities.js"],g["Core/Globals.js"],g["Core/Utilities.js"]],function(a,g,y){var z=g.deg2rad,C=y.clamp,D=y.correctFloat,J=y.defined,t=y.destroyObjectProperties,q=y.extend,n=y.fireEvent,e=y.isNumber,
d=y.merge,h=y.objectEach,m=y.pick;g=function(){function g(d,e,a,h,g){this.isNewLabel=this.isNew=!0;this.axis=d;this.pos=e;this.type=a||"";this.parameters=g||{};this.tickmarkOffset=this.parameters.tickmarkOffset;this.options=this.parameters.options;n(this,"init");a||h||this.addLabel()}g.prototype.addLabel=function(){var d=this,h=d.axis,g=h.options,k=h.chart,I=h.categories,x=h.logarithmic,c=h.names,u=d.pos,f=m(d.options&&d.options.labels,g.labels),l=h.tickPositions,b=u===l[0],v=u===l[l.length-1],A=
(!f.step||1===f.step)&&1===h.tickInterval;l=l.info;var p=d.label,M;I=this.parameters.category||(I?m(I[u],c[u],u):u);x&&e(I)&&(I=D(x.lin2log(I)));if(h.dateTime)if(l)var F=k.time.resolveDTLFormat(g.dateTimeLabelFormats[!g.grid&&l.higherRanks[u]||l.unitName]),N=F.main;else e(I)&&(N=h.dateTime.getXDateFormat(I,g.dateTimeLabelFormats||{}));d.isFirst=b;d.isLast=v;var Q={axis:h,chart:k,dateTimeLabelFormat:N,isFirst:b,isLast:v,pos:u,tick:d,tickPositionInfo:l,value:I};n(this,"labelFormat",Q);var t=function(b){return f.formatter?
f.formatter.call(b,b):f.format?(b.text=h.defaultLabelFormatter.call(b,b),a.format(f.format,b,k)):h.defaultLabelFormatter.call(b,b)};g=t.call(Q,Q);var Y=F&&F.list;d.shortenLabel=Y?function(){for(M=0;M<Y.length;M++)if(q(Q,{dateTimeLabelFormat:Y[M]}),p.attr({text:t.call(Q,Q)}),p.getBBox().width<h.getSlotWidth(d)-2*f.padding)return;p.attr({text:""})}:void 0;A&&h._addedPlotLB&&d.moveLabel(g,f);J(p)||d.movedLabel?p&&p.textStr!==g&&!A&&(!p.textWidth||f.style.width||p.styles.width||p.css({width:null}),p.attr({text:g}),
p.textPxLength=p.getBBox().width):(d.label=p=d.createLabel({x:0,y:0},g,f),d.rotation=0)};g.prototype.createLabel=function(e,a,h){var g=this.axis,m=g.chart;if(e=J(a)&&h.enabled?m.renderer.text(a,e.x,e.y,h.useHTML).add(g.labelGroup):null)m.styledMode||e.css(d(h.style)),e.textPxLength=e.getBBox().width;return e};g.prototype.destroy=function(){t(this,this.axis)};g.prototype.getPosition=function(d,e,a,h){var g=this.axis,m=g.chart,c=h&&m.oldChartHeight||m.chartHeight;d={x:d?D(g.translate(e+a,void 0,void 0,
h)+g.transB):g.left+g.offset+(g.opposite?(h&&m.oldChartWidth||m.chartWidth)-g.right-g.left:0),y:d?c-g.bottom+g.offset-(g.opposite?g.height:0):D(c-g.translate(e+a,void 0,void 0,h)-g.transB)};d.y=C(d.y,-1E5,1E5);n(this,"afterGetPosition",{pos:d});return d};g.prototype.getLabelPosition=function(d,e,a,h,g,m,c,u){var f=this.axis,l=f.transA,b=f.isLinked&&f.linkedParent?f.linkedParent.reversed:f.reversed,v=f.staggerLines,A=f.tickRotCorr||{x:0,y:0},p=h||f.reserveSpaceDefault?0:-f.labelOffset*("center"===
f.labelAlign?.5:1),k={};a=0===f.side?a.rotation?-8:-a.getBBox().height:2===f.side?A.y+8:Math.cos(a.rotation*z)*(A.y-a.getBBox(!1,0).height/2);J(g.y)&&(a=0===f.side&&f.horiz?g.y+a:g.y);d=d+g.x+p+A.x-(m&&h?m*l*(b?-1:1):0);e=e+a-(m&&!h?m*l*(b?1:-1):0);v&&(h=c/(u||1)%v,f.opposite&&(h=v-h-1),e+=f.labelOffset/v*h);k.x=d;k.y=Math.round(e);n(this,"afterGetLabelPosition",{pos:k,tickmarkOffset:m,index:c});return k};g.prototype.getLabelSize=function(){return this.label?this.label.getBBox()[this.axis.horiz?"height":
"width"]:0};g.prototype.getMarkPath=function(d,e,a,h,g,m){return m.crispLine([["M",d,e],["L",d+(g?0:-a),e+(g?a:0)]],h)};g.prototype.handleOverflow=function(d){var e=this.axis,a=e.options.labels,h=d.x,g=e.chart.chartWidth,k=e.chart.spacing,c=m(e.labelLeft,Math.min(e.pos,k[3]));k=m(e.labelRight,Math.max(e.isRadial?0:e.pos+e.len,g-k[1]));var u=this.label,f=this.rotation,l={left:0,center:.5,right:1}[e.labelAlign||u.attr("align")],b=u.getBBox().width,v=e.getSlotWidth(this),A={},p=v,r=1,n;if(f||"justify"!==
a.overflow)0>f&&h-l*b<c?n=Math.round(h/Math.cos(f*z)-c):0<f&&h+l*b>k&&(n=Math.round((g-h)/Math.cos(f*z)));else if(g=h+(1-l)*b,h-l*b<c?p=d.x+p*(1-l)-c:g>k&&(p=k-d.x+p*l,r=-1),p=Math.min(v,p),p<v&&"center"===e.labelAlign&&(d.x+=r*(v-p-l*(v-Math.min(b,p)))),b>p||e.autoRotation&&(u.styles||{}).width)n=p;n&&(this.shortenLabel?this.shortenLabel():(A.width=Math.floor(n)+"px",(a.style||{}).textOverflow||(A.textOverflow="ellipsis"),u.css(A)))};g.prototype.moveLabel=function(d,e){var a=this,g=a.label,m=a.axis,
k=m.reversed,c=!1;g&&g.textStr===d?(a.movedLabel=g,c=!0,delete a.label):h(m.ticks,function(f){c||f.isNew||f===a||!f.label||f.label.textStr!==d||(a.movedLabel=f.label,c=!0,f.labelPos=a.movedLabel.xy,delete f.label)});if(!c&&(a.labelPos||g)){var u=a.labelPos||g.xy;g=m.horiz?k?0:m.width+m.left:u.x;m=m.horiz?u.y:k?m.width+m.left:0;a.movedLabel=a.createLabel({x:g,y:m},d,e);a.movedLabel&&a.movedLabel.attr({opacity:0})}};g.prototype.render=function(d,e,a){var h=this.axis,g=h.horiz,k=this.pos,c=m(this.tickmarkOffset,
h.tickmarkOffset);k=this.getPosition(g,k,c,e);c=k.x;var u=k.y;h=g&&c===h.pos+h.len||!g&&u===h.pos?-1:1;g=m(a,this.label&&this.label.newOpacity,1);a=m(a,1);this.isActive=!0;this.renderGridLine(e,a,h);this.renderMark(k,a,h);this.renderLabel(k,e,g,d);this.isNew=!1;n(this,"afterRender")};g.prototype.renderGridLine=function(d,e,a){var h=this.axis,g=h.options,k={},c=this.pos,u=this.type,f=m(this.tickmarkOffset,h.tickmarkOffset),l=h.chart.renderer,b=this.gridLine,v=g.gridLineWidth,A=g.gridLineColor,p=g.gridLineDashStyle;
"minor"===this.type&&(v=g.minorGridLineWidth,A=g.minorGridLineColor,p=g.minorGridLineDashStyle);b||(h.chart.styledMode||(k.stroke=A,k["stroke-width"]=v||0,k.dashstyle=p),u||(k.zIndex=1),d&&(e=0),this.gridLine=b=l.path().attr(k).addClass("highcharts-"+(u?u+"-":"")+"grid-line").add(h.gridGroup));if(b&&(a=h.getPlotLinePath({value:c+f,lineWidth:b.strokeWidth()*a,force:"pass",old:d,acrossPanes:!1})))b[d||this.isNew?"attr":"animate"]({d:a,opacity:e})};g.prototype.renderMark=function(d,e,a){var h=this.axis,
g=h.options,k=h.chart.renderer,c=this.type,u=h.tickSize(c?c+"Tick":"tick"),f=d.x;d=d.y;var l=m(g["minor"!==c?"tickWidth":"minorTickWidth"],!c&&h.isXAxis?1:0);g=g["minor"!==c?"tickColor":"minorTickColor"];var b=this.mark,v=!b;u&&(h.opposite&&(u[0]=-u[0]),b||(this.mark=b=k.path().addClass("highcharts-"+(c?c+"-":"")+"tick").add(h.axisGroup),h.chart.styledMode||b.attr({stroke:g,"stroke-width":l})),b[v?"attr":"animate"]({d:this.getMarkPath(f,d,u[0],b.strokeWidth()*a,h.horiz,k),opacity:e}))};g.prototype.renderLabel=
function(d,a,h,g){var k=this.axis,n=k.horiz,c=k.options,u=this.label,f=c.labels,l=f.step;k=m(this.tickmarkOffset,k.tickmarkOffset);var b=d.x;d=d.y;var v=!0;u&&e(b)&&(u.xy=d=this.getLabelPosition(b,d,u,n,f,k,g,l),this.isFirst&&!this.isLast&&!c.showFirstLabel||this.isLast&&!this.isFirst&&!c.showLastLabel?v=!1:!n||f.step||f.rotation||a||0===h||this.handleOverflow(d),l&&g%l&&(v=!1),v&&e(d.y)?(d.opacity=h,u[this.isNewLabel?"attr":"animate"](d).show(!0),this.isNewLabel=!1):(u.hide(),this.isNewLabel=!0))};
g.prototype.replaceMovedLabel=function(){var d=this.label,e=this.axis,a=e.reversed;if(d&&!this.isNew){var h=e.horiz?a?e.left:e.width+e.left:d.xy.x;a=e.horiz?d.xy.y:a?e.width+e.top:e.top;d.animate({x:h,y:a,opacity:0},void 0,d.destroy);delete this.label}e.isDirty=!0;this.label=this.movedLabel;delete this.movedLabel};return g}();"";return g});L(g,"Core/Axis/Axis.js",[g["Core/Animation/AnimationUtilities.js"],g["Core/Axis/AxisDefaults.js"],g["Core/Color/Color.js"],g["Core/Defaults.js"],g["Core/Foundation.js"],
g["Core/Globals.js"],g["Core/Axis/Tick.js"],g["Core/Utilities.js"]],function(a,g,y,E,C,D,J,t){var q=a.animObject,n=E.defaultOptions,e=C.registerEventOptions,d=D.deg2rad,h=t.arrayMax,m=t.arrayMin,k=t.clamp,r=t.correctFloat,B=t.defined,G=t.destroyObjectProperties,K=t.erase,I=t.error,x=t.extend,c=t.fireEvent,u=t.isArray,f=t.isNumber,l=t.isString,b=t.merge,v=t.normalizeTickInterval,A=t.objectEach,p=t.pick,M=t.relativeLength,F=t.removeEvent,N=t.splat,Q=t.syncTimeout,z=function(b,c){return v(c,void 0,void 0,
p(b.options.allowDecimals,.5>c||void 0!==b.tickAmount),!!b.tickAmount)};a=function(){function a(b,c){this.zoomEnabled=this.width=this.visible=this.userOptions=this.translationSlope=this.transB=this.transA=this.top=this.ticks=this.tickRotCorr=this.tickPositions=this.tickmarkOffset=this.tickInterval=this.tickAmount=this.side=this.series=this.right=this.positiveValuesOnly=this.pos=this.pointRangePadding=this.pointRange=this.plotLinesAndBandsGroups=this.plotLinesAndBands=this.paddedTicks=this.overlap=
this.options=this.offset=this.names=this.minPixelPadding=this.minorTicks=this.minorTickInterval=this.min=this.maxLabelLength=this.max=this.len=this.left=this.labelFormatter=this.labelEdge=this.isLinked=this.height=this.hasVisibleSeries=this.hasNames=this.eventOptions=this.coll=this.closestPointRange=this.chart=this.bottom=this.alternateBands=void 0;this.init(b,c)}a.prototype.init=function(b,d){var a=d.isX;this.chart=b;this.horiz=b.inverted&&!this.isZAxis?!a:a;this.isXAxis=a;this.coll=this.coll||(a?
"xAxis":"yAxis");c(this,"init",{userOptions:d});this.opposite=p(d.opposite,this.opposite);this.side=p(d.side,this.side,this.horiz?this.opposite?0:2:this.opposite?1:3);this.setOptions(d);var w=this.options,h=w.labels,l=w.type;this.userOptions=d;this.minPixelPadding=0;this.reversed=p(w.reversed,this.reversed);this.visible=w.visible;this.zoomEnabled=w.zoomEnabled;this.hasNames="category"===l||!0===w.categories;this.categories=w.categories||(this.hasNames?[]:void 0);this.names||(this.names=[],this.names.keys=
...
b[this.coll].push(this));this.series=this.series||[];b.inverted&&!this.isZAxis&&a&&"undefined"===typeof this.reversed&&(this.reversed=!0);this.labelRotation=f(h.rotation)?h.rotation:void 0;e(this,w);c(this,"afterInit")};a.prototype.setOptions=function(f){this.options=b(g.defaultXAxisOptions,"yAxis"===this.coll&&g.defaultYAxisOptions,[g.defaultTopAxisOptions,g.defaultRightAxisOptions,g.defaultBottomAxisOptions,g.defaultLeftAxisOptions][this.side],b(n[this.coll],f));c(this,"afterSetOptions",{userOptions:f})};
a.prototype.defaultLabelFormatter=function(b){var c=this.axis;b=this.chart.numberFormatter;var d=f(this.value)?this.value:NaN,a=c.chart.time,e=this.dateTimeLabelFormat,w=n.lang,h=w.numericSymbols;w=w.numericSymbolMagnitude||1E3;var l=c.logarithmic?Math.abs(d):c.tickInterval,p=h&&h.length;if(c.categories)var v="".concat(this.value);else if(e)v=a.dateFormat(e,d);else if(p&&1E3<=l)for(;p--&&"undefined"===typeof v;)c=Math.pow(w,p+1),l>=c&&0===10*d%c&&null!==h[p]&&0!==d&&(v=b(d/c,-1)+h[p]);"undefined"===
typeof v&&(v=1E4<=Math.abs(d)?b(d,-1):b(d,-1,void 0,""));return v};a.prototype.getSeriesExtremes=function(){var b=this,d=b.chart,a;c(this,"getSeriesExtremes",null,function(){b.hasVisibleSeries=!1;b.dataMin=b.dataMax=b.threshold=null;b.softThreshold=!b.isXAxis;b.series.forEach(function(c){if(c.visible||!d.options.chart.ignoreHiddenSeries){var e=c.options,w=e.threshold;b.hasVisibleSeries=!0;b.positiveValuesOnly&&0>=w&&(w=null);if(b.isXAxis){if(e=c.xData,e.length){e=b.logarithmic?e.filter(b.validatePositiveValue):
e;a=c.getXExtremes(e);var h=a.min,l=a.max;f(h)||h instanceof Date||(e=e.filter(f),a=c.getXExtremes(e),h=a.min,l=a.max);e.length&&(b.dataMin=Math.min(p(b.dataMin,h),h),b.dataMax=Math.max(p(b.dataMax,l),l))}}else if(c=c.applyExtremes(),f(c.dataMin)&&(h=c.dataMin,b.dataMin=Math.min(p(b.dataMin,h),h)),f(c.dataMax)&&(l=c.dataMax,b.dataMax=Math.max(p(b.dataMax,l),l)),B(w)&&(b.threshold=w),!e.softThreshold||b.positiveValuesOnly)b.softThreshold=!1}})});c(this,"afterGetSeriesExtremes")};a.prototype.translate=
function(b,c,d,a,e,h){var w=this.linkedParent||this,l=a&&w.old?w.old.min:w.min;if(!f(l))return NaN;var p=w.minPixelPadding;e=(w.isOrdinal||w.brokenAxis&&w.brokenAxis.hasBreaks||w.logarithmic&&e)&&w.lin2val;var v=1,H=0;(a=a&&w.old?w.old.transA:w.transA)||(a=w.transA);d&&(v*=-1,H=w.len);w.reversed&&(v*=-1,H-=v*(w.sector||w.len));c?(h=(b*v+H-p)/a+l,e&&(h=w.lin2val(h))):(e&&(b=w.val2lin(b)),b=v*(b-l)*a,h=(w.isRadial?b:r(b))+H+v*p+(f(h)?a*h:0));return h};a.prototype.toPixels=function(b,c){return this.translate(b,
!1,!this.horiz,void 0,!0)+(c?0:this.pos)};a.prototype.toValue=function(b,c){return this.translate(b-(c?0:this.pos),!0,!this.horiz,void 0,!0)};a.prototype.getPlotLinePath=function(b){function d(b,c,f){"pass"!==r&&(b<c||b>f)&&(r?b=k(b,c,f):q=!0);return b}var a=this,e=a.chart,w=a.left,h=a.top,l=b.old,v=b.value,g=b.lineWidth,u=l&&e.oldChartHeight||e.chartHeight,A=l&&e.oldChartWidth||e.chartWidth,m=a.transB,n=b.translatedValue,r=b.force,x,F,M,N,q;b={value:v,lineWidth:g,old:l,force:r,acrossPanes:b.acrossPanes,
...
function(b){var d=this.chart,a=this.logarithmic,e=this.options,h=this.isXAxis,l=this.isLinked,v=e.tickPixelInterval,w=this.categories,g=this.softThreshold,u=e.maxPadding,A=e.minPadding,k=f(e.tickInterval)&&0<=e.tickInterval?e.tickInterval:void 0,m=f(this.threshold)?this.threshold:null;this.dateTime||w||l||this.getTickAmount();var n=p(this.userMin,e.min),x=p(this.userMax,e.max);if(l){this.linkedParent=d[this.coll][e.linkedTo];var F=this.linkedParent.getExtremes();this.min=p(F.min,F.dataMin);this.max=
...
[]).forEach(function(d){e.addPlotBandOrLine(d)}));if(d){var n=g[d]||[];n.push(a);g[d]=n}this.plotLinesAndBands.push(k)}return k};a.prototype.removePlotBandOrLine=function(a){var d=this.plotLinesAndBands,e=this.options,m=this.userOptions;if(d){for(var k=d.length;k--;)d[k].id===a&&d[k].destroy();[e.plotLines||[],m.plotLines||[],e.plotBands||[],m.plotBands||[]].forEach(function(d){for(k=d.length;k--;)(d[k]||{}).id===a&&g(d,d[k])})}};a.prototype.removePlotBand=function(a){this.removePlotBandOrLine(a)};
a.prototype.removePlotLine=function(a){this.removePlotBandOrLine(a)};return a}()})(C||(C={}));return C});L(g,"Core/Axis/PlotLineOrBand/PlotLineOrBand.js",[g["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"],g["Core/Utilities.js"]],function(a,g){var z=g.arrayMax,E=g.arrayMin,C=g.defined,D=g.destroyObjectProperties,J=g.erase,t=g.fireEvent,q=g.merge,n=g.objectEach,e=g.pick;g=function(){function d(d,a){this.axis=d;a&&(this.options=a,this.id=a.id)}d.compose=function(e){return a.compose(d,e)};d.prototype.render=
...
"px"}));m.show(!0)};d.prototype.getLabelText=function(d){return C(d.formatter)?d.formatter.call(this):d.text};d.prototype.destroy=function(){J(this.axis.plotLinesAndBands,this);delete this.axis;D(this)};return d}();"";"";return g});L(g,"Core/Tooltip.js",[g["Core/FormatUtilities.js"],g["Core/Globals.js"],g["Core/Renderer/RendererUtilities.js"],g["Core/Renderer/RendererRegistry.js"],g["Core/Utilities.js"]],function(a,g,y,E,C){var z=a.format,J=g.doc,t=y.distribute,q=C.clamp,n=C.css,e=C.discardElement,
...
"")})};a.prototype.cleanSplit=function(c){this.chart.series.forEach(function(a){var f=a&&a.tt;f&&(!f.isActive||c?a.tt=f.destroy():f.isActive=!1)})};a.prototype.defaultFormatter=function(c){var a=this.points||K(this),f=[c.tooltipFooterHeaderFormatter(a[0])];f=f.concat(c.bodyFormatter(a));f.push(c.tooltipFooterHeaderFormatter(a[0],!0));return f};a.prototype.destroy=function(){this.label&&(this.label=this.label.destroy());this.split&&this.tt&&(this.cleanSplit(!0),this.tt=this.tt.destroy());this.renderer&&
...
b.height);this.tracker?this.tracker.attr(d):(this.tracker=a.renderer.rect(d).addClass("highcharts-tracker").add(a),c.styledMode||this.tracker.attr({fill:"rgba(0,0,0,0)"}))}}else this.tracker&&this.tracker.destroy()};a.prototype.styledModeFormat=function(c){return c.replace('style\x3d"font-size: 10px"','class\x3d"highcharts-header"').replace(/style="color:{(point|series)\.color}"/g,'class\x3d"highcharts-color-{$1.colorIndex} {series.options.className} {point.options.className}"')};a.prototype.tooltipFooterHeaderFormatter=
...
b);if(!n.styledMode){e=f.pointAttribs(this,b);var H=x(n.options.chart.animation,g.animation),P=e.opacity;f.options.inactiveOtherPoints&&B(P)&&((this.dataLabels||[]).forEach(function(b){b&&!b.hasClass("highcharts-data-label-hidden")&&b.animate({opacity:P},H)}),this.connector&&this.connector.animate({opacity:P},H));this.graphic.animate(e,H)}t&&this.graphic.animate(t,x(n.options.chart.animation,k.animation,l.animation));G&&G.hide()}else{if(b&&k){l=m.symbol||f.symbol;G&&G.currentSymbol!==l&&(G=G.destroy());
...
function(c){c=c.relatedTarget||c.toElement;var a=this.chart.hoverSeries;this.isDirectTouch=!1;if(!(!a||!c||a.stickyTracking||this.inClass(c,"highcharts-tooltip")||this.inClass(c,"highcharts-series-"+a.index)&&this.inClass(c,"highcharts-tracker")))a.onMouseOut()};a.prototype.inClass=function(c,a){for(var d;c;){if(d=q(c,"class")){if(-1!==d.indexOf(a))return!0;if(-1!==d.indexOf("highcharts-container"))return!1}c=c.parentElement}};a.prototype.init=function(c,a){this.options=a;this.chart=c;this.runChartClick=
...
function(){var c=this.chart,d=g.charts[K(a.hoverChartIndex,-1)];if(d&&d!==c)d.pointer.onContainerMouseLeave({relatedTarget:c.container});d&&d.mouseIsDown||(a.hoverChartIndex=c.index)};a.prototype.touch=function(a,d){var c=this.chart;this.setHoverChartIndex();if(1===a.touches.length)if(a=this.normalize(a),c.isInsidePlot(a.chartX-c.plotLeft,a.chartY-c.plotTop,{visiblePlotOnly:!0})&&!c.openMenu){d&&this.runPointActions(a);if("touchmove"===a.type){d=this.pinchDown;var e=d[0]?4<=Math.sqrt(Math.pow(d[0].chartX-
a.chartX,2)+Math.pow(d[0].chartY-a.chartY,2)):!1}K(e,!0)&&this.pinch(a)}else d&&this.reset();else 2===a.touches.length&&this.pinch(a)};a.prototype.touchSelect=function(a){return!(!this.chart.options.chart.zooming.singleTouch||!a.touches||1!==a.touches.length)};a.prototype.zoomOption=function(a){var c=this.chart,d=c.options.chart;c=c.inverted;var e=d.zooming.type||"";/touch/.test(a.type)&&(e=K(d.zooming.pinchType,e));this.zoomX=a=/x/.test(e);this.zoomY=d=/y/.test(e);this.zoomHor=a&&!c||d&&c;this.zoomVert=
...
b.linkedSeries.length:0})};a.prototype.orderSeries=function(b){var a=this.series;b=b||0;for(var c=a.length;b<c;++b)a[b]&&(a[b].index=b,a[b].name=a[b].getName())};a.prototype.isInsidePlot=function(b,a,c){void 0===c&&(c={});var d=this.inverted,f=this.plotBox,e=this.plotLeft,h=this.plotTop,g=this.scrollablePlotBox,l=0,k=0;c.visiblePlotOnly&&this.scrollingContainer&&(k=this.scrollingContainer,l=k.scrollLeft,k=k.scrollTop);var m=c.series;f=c.visiblePlotOnly&&g||f;g=c.inverted?a:b;a=c.inverted?b:a;b={x:g,
y:a,isInsidePlot:!0,options:c};if(!c.ignoreX){var p=m&&(d&&!this.polar?m.yAxis:m.xAxis)||{pos:e,len:Infinity};g=c.paneCoordinates?p.pos+g:e+g;g>=Math.max(l+e,p.pos)&&g<=Math.min(l+e+f.width,p.pos+p.len)||(b.isInsidePlot=!1)}!c.ignoreY&&b.isInsidePlot&&(d=c.axis&&!c.axis.isXAxis&&c.axis||m&&(d?m.xAxis:m.yAxis)||{pos:h,len:Infinity},c=c.paneCoordinates?d.pos+a:h+a,c>=Math.max(k+h,d.pos)&&c<=Math.min(k+h+f.height,d.pos+d.len)||(b.isInsidePlot=!1));S(this,"afterIsInsidePlot",b);return b.isInsidePlot};
...
l.addClass("highcharts-animating").animate(a,h)}};a.prototype.afterAnimate=function(){var b=this;this.setClip();Y(this.chart.sharedClips,function(a,c,d){a&&!b.chart.container.querySelector('[clip-path\x3d"url(#'.concat(a.id,')"]'))&&(a.destroy(),delete d[c])});this.finishedAnimating=!0;p(this,"afterAnimate")};a.prototype.drawPoints=function(b){void 0===b&&(b=this.points);var a=this.chart,c=a.styledMode,d=this.colorAxis,f=this.options.marker,e=this[this.specialGroup||"markerGroup"],h=this.xAxis,g=
w(f.enabled,!h||h.isRadial?!0:null,this.closestPointRangePx>=f.enabledThreshold*f.radius),l,k;if(!1!==f.enabled||this._hasPointMarkers)for(l=0;l<b.length;l++){var m=b[l],n=(k=m.graphic)?"animate":"attr",p=m.marker||{},v=!!m.marker;if((g&&"undefined"===typeof p.enabled||p.enabled)&&!m.isNull&&!1!==m.visible){var r=w(p.symbol,this.symbol,"rect"),u=this.markerAttribs(m,m.selected&&"select");this.enabledDataSorting&&(m.startXPos=h.reversed?-(u.width||0):h.width);var H=!1!==m.isInside;!k&&H&&(0<(u.width||
...
function(){var b=this,a=this.chart,c=a.renderer,d=this.zones,f=this.clips||[],e=this.graph,h=this.area,g=Math.max(a.plotWidth,a.plotHeight),l=this[(this.zoneAxis||"y")+"Axis"],k=a.inverted,m,n,p,v,r,u,q,A,t=!1;if(d.length&&(e||h)&&l&&"undefined"!==typeof l.min){var B=l.reversed,F=l.horiz;e&&!this.showLine&&e.hide();h&&h.hide();var G=l.getExtremes();d.forEach(function(d,H){m=B?F?a.plotWidth:0:F?0:l.toPixels(G.min)||0;m=x(w(n,m),0,g);n=x(Math.round(l.toPixels(w(d.value,G.max),!0)||0),0,g);t&&(m=n=l.toPixels(G.max));
v=Math.abs(m-n);r=Math.min(m,n);u=Math.max(m,n);l.isXAxis?(p={x:k?u:r,y:0,width:v,height:g},F||(p.x=a.plotHeight-p.x)):(p={x:0,y:k?u:r,width:g,height:v},F&&(p.y=a.plotWidth-p.y));k&&c.isVML&&(p=l.isXAxis?{x:0,y:B?r:u,height:p.width,width:a.chartWidth}:{x:p.y-a.plotLeft-a.spacingBox.x,y:0,width:p.height,height:a.chartHeight});f[H]?f[H].animate(p):f[H]=c.clipRect(p);q=b["zone-area-"+H];A=b["zone-graph-"+H];e&&A&&A.clip(f[H]);h&&q&&q.clip(f[H]);t=d.value>G.max;b.resetZones&&0===n&&(n=void 0)});this.clips=
f}else b.visible&&(e&&e.show(),h&&h.show())};a.prototype.plotGroup=function(b,a,c,d,e){var h=this[b],g=!h;c={visibility:c,zIndex:d||.1};"undefined"===typeof this.opacity||this.chart.styledMode||"inactive"===this.state||(c.opacity=this.opacity);g&&(this[b]=h=this.chart.renderer.g().add(e));h.addClass("highcharts-"+a+" highcharts-series-"+this.index+" highcharts-"+this.type+"-series "+(f(this.colorIndex)?"highcharts-color-"+this.colorIndex+" ":"")+(this.options.className||"")+(h.hasClass("highcharts-tracker")?
" highcharts-tracker":""),!0);h.attr(c)[g?"attr":"animate"](this.getPlotBox(a));return h};a.prototype.getPlotBox=function(b){var a=this.xAxis,c=this.yAxis,d=this.chart;b=d.inverted&&!d.polar&&a&&!1!==this.invertible&&"series"===b;d.inverted&&(a=c,c=this.xAxis);return{translateX:a?a.left:d.plotLeft,translateY:c?c.top:d.plotTop,rotation:b?90:0,rotationOriginX:b?(a.len-c.len)/2:0,rotationOriginY:b?(a.len+c.len)/2:0,scaleX:b?-1:1,scaleY:1}};a.prototype.removeEvents=function(b){b||T(this);this.eventsToUnbind.length&&
(this.eventsToUnbind.forEach(function(b){b()}),this.eventsToUnbind.length=0)};a.prototype.render=function(){var b=this,a=b.chart,c=b.options,d=e(c.animation),f=b.visible?"inherit":"hidden",h=c.zIndex,g=b.hasRendered,l=a.seriesGroup;a=!b.finishedAnimating&&a.renderer.isSVG?d.duration:0;p(this,"render");b.plotGroup("group","series",f,h,l);b.markerGroup=b.plotGroup("markerGroup","markers",f,h,l);!1!==c.clip&&b.setClip();b.animate&&a&&b.animate(!0);b.drawGraph&&(b.drawGraph(),b.applyZones());b.visible&&
b.drawPoints();b.drawDataLabels&&b.drawDataLabels();b.redrawPoints&&b.redrawPoints();b.drawTracker&&!1!==b.options.enableMouseTracking&&b.drawTracker();b.animate&&a&&b.animate();g||(a&&d.defer&&(a+=d.defer),b.animationTimeout=ca(function(){b.afterAnimate()},a||0));b.isDirty=!1;b.hasRendered=!0;p(b,"afterRender")};a.prototype.redraw=function(){var b=this.isDirty||this.isDirtyData;this.translate();this.render();b&&delete this.kdTree};a.prototype.searchPoint=function(b,a){var c=this.xAxis,d=this.yAxis,
f=this.chart.inverted;return this.searchKDTree({clientX:f?c.len-b.chartY+c.pos:b.chartX-c.pos,plotY:f?d.len-b.chartX+d.pos:b.chartY-d.pos},a,b)};a.prototype.buildKDTree=function(b){function a(b,d,f){var e=b&&b.length;if(e){var h=c.kdAxisArray[d%f];b.sort(function(b,a){return b[h]-a[h]});e=Math.floor(e/2);return{point:b[e],left:a(b.slice(0,e),d+1,f),right:a(b.slice(e+1),d+1,f)}}}this.buildingKdTree=!0;var c=this,d=-1<c.options.findNearestPointBy.indexOf("y")?2:1;delete c.kdTree;ca(function(){c.kdTree=
a(c.getValidPoints(null,!c.directTouch),d,d);c.buildingKdTree=!1},c.options.kdNow||b&&"touchstart"===b.type?0:1)};a.prototype.searchKDTree=function(b,a,c){function d(b,a,c,k){var m=a.point,n=e.kdAxisArray[c%k],p=m,v=f(b[h])&&f(m[h])?Math.pow(b[h]-m[h],2):null,r=f(b[g])&&f(m[g])?Math.pow(b[g]-m[g],2):null;r=(v||0)+(r||0);m.dist=f(r)?Math.sqrt(r):Number.MAX_VALUE;m.distX=f(v)?Math.sqrt(v):Number.MAX_VALUE;n=b[n]-m[n];r=0>n?"left":"right";v=0>n?"right":"left";a[r]&&(r=d(b,a[r],c+1,k),p=r[l]<p[l]?r:m);
a[v]&&Math.sqrt(n*n)<p[l]&&(b=d(b,a[v],c+1,k),p=b[l]<p[l]?b:p);return p}var e=this,h=this.kdAxisArray[0],g=this.kdAxisArray[1],l=a?"distX":"dist";a=-1<e.options.findNearestPointBy.indexOf("y")?2:1;this.kdTree||this.buildingKdTree||this.buildKDTree(c);if(this.kdTree)return d(b,this.kdTree,a,a)};a.prototype.pointPlacementToXValue=function(){var b=this.options,a=b.pointRange,c=this.xAxis;b=b.pointPlacement;"between"===b&&(b=c.reversed?-.5:.5);return N(b)?b*(a||c.pointRange):0};a.prototype.isPointInside=
function(b){var a=this.chart,c=this.xAxis,d=this.yAxis;return"undefined"!==typeof b.plotY&&"undefined"!==typeof b.plotX&&0<=b.plotY&&b.plotY<=(d?d.len:a.plotHeight)&&0<=b.plotX&&b.plotX<=(c?c.len:a.plotWidth)};a.prototype.drawTracker=function(){var b=this,a=b.options,c=a.trackByArea,d=[].concat(c?b.areaPath:b.graphPath),f=b.chart,e=f.pointer,h=f.renderer,g=f.options.tooltip.snap,l=b.tracker,m=function(a){if(f.hoverSeries!==b)b.onMouseOver()},n="rgba(192,192,192,"+(r?1E-4:.002)+")";l?l.attr({d:d}):
b.graph&&(b.tracker=h.path(d).attr({visibility:b.visible?"inherit":"hidden",zIndex:2}).addClass(c?"highcharts-tracker-area":"highcharts-tracker-line").add(b.group),f.styledMode||b.tracker.attr({"stroke-linecap":"round","stroke-linejoin":"round",stroke:n,fill:c?n:"none","stroke-width":b.graph.strokeWidth()+(c?0:2*g)}),[b.tracker,b.markerGroup,b.dataLabelsGroup].forEach(function(b){if(b&&(b.addClass("highcharts-tracker").on("mouseover",m).on("mouseout",function(b){e.onTrackerMouseOut(b)}),a.cursor&&
!f.styledMode&&b.css({cursor:a.cursor}),k))b.on("touchstart",m)}));p(this,"afterDrawTracker")};a.prototype.addPoint=function(b,a,c,d,f){var e=this.options,h=this.data,g=this.chart,l=this.xAxis;l=l&&l.hasNames&&l.names;var k=e.data,m=this.xData,n;a=w(a,!0);var v={series:this};this.pointClass.prototype.applyOptions.apply(v,[b]);var r=v.x,u=m.length;if(this.requireSorting&&r<m[u-1])for(n=!0;u&&m[u-1]>r;)u--;this.updateParallelArrays(v,"splice",u,0,0);this.updateParallelArrays(v,u);l&&v.name&&(l[r]=v.name);
k.splice(u,0,b);if(n||this.processedData)this.data.splice(u,0,null),this.processData();"point"===e.legendType&&this.generatePoints();c&&(h[0]&&h[0].remove?h[0].remove(!1):(h.shift(),this.updateParallelArrays(v,"shift"),k.shift()));!1!==f&&p(this,"addPoint",{point:v});this.isDirtyData=this.isDirty=!0;a&&g.redraw(d)};a.prototype.removePoint=function(b,a,c){var f=this,e=f.data,h=e[b],g=f.points,l=f.chart,k=function(){g&&g.length===e.length&&g.splice(b,1);e.splice(b,1);f.options.data.splice(b,1);f.updateParallelArrays(h||
{series:f},"splice",b,1);h&&h.destroy();f.isDirty=!0;f.isDirtyData=!0;a&&l.redraw()};d(c,l);a=w(a,!0);h?h.firePointEvent("remove",null,k):k()};a.prototype.remove=function(b,a,c,d){function f(){e.destroy(d);h.isDirtyLegend=h.isDirtyBox=!0;h.linkSeries();w(b,!0)&&h.redraw(a)}var e=this,h=e.chart;!1!==c?p(e,"remove",null,f):f()};a.prototype.update=function(a,d){a=c(a,this.userOptions);p(this,"update",{options:a});var f=this,e=f.chart,h=f.userOptions,g=f.initialType||f.type,l=e.options.plotOptions,k=
G[g].prototype,m=f.finishedAnimating&&{animation:!1},n={},r=["eventOptions","navigatorSeries","baseSeries"],u=a.type||h.type||e.options.chart.type,q=!(this.hasDerivedData||u&&u!==this.type||"undefined"!==typeof a.pointStart||"undefined"!==typeof a.pointInterval||"undefined"!==typeof a.relativeXValue||a.joinBy||a.mapData||f.hasOptionChanged("dataGrouping")||f.hasOptionChanged("pointStart")||f.hasOptionChanged("pointInterval")||f.hasOptionChanged("pointIntervalUnit")||f.hasOptionChanged("keys"));u=
u||g;q&&(r.push("data","isDirtyData","points","processedData","processedXData","processedYData","xIncrement","cropped","_hasPointMarkers","_hasPointLabels","clips","nodes","layout","level","mapMap","mapData","minY","maxY","minX","maxX"),!1!==a.visible&&r.push("area","graph"),f.parallelArrays.forEach(function(b){r.push(b+"Data")}),a.data&&(a.dataSorting&&v(f.options.dataSorting,a.dataSorting),this.setData(a.data,!1)));a=W(h,m,{index:"undefined"===typeof h.index?f.index:h.index,pointStart:w(l&&l.series&&
...
c?a.yAxis[0]:this.yAxis;var r=a.stacking.stacks,u=a.stacking.oldStacks,q,t;a.stacking.stacksTouched+=1;for(t=0;t<g;t++){var z=d[t],y=e[t],K=this.getStackIndicator(K,z,this.index),C=K.key,I=(q=v&&y<(m?0:k))?n:b;r[I]||(r[I]={});r[I][z]||(u[I]&&u[I][z]?(r[I][z]=u[I][z],r[I][z].total=null):r[I][z]=new E(a,a.options.stackLabels,!!q,z,l));I=r[I][z];null!==y?(I.points[C]=I.points[this.index]=[f(I.cumulative,m)],G(I.cumulative)||(I.base=C),I.touched=a.stacking.stacksTouched,0<K.index&&!1===this.singleStacks&&
(I.points[C][0]=I.points[this.index+","+z+",0"][0])):I.points[C]=I.points[this.index]=null;"percent"===c?(q=q?b:n,v&&r[q]&&r[q][z]?(q=r[q][z],I.total=q.total=Math.max(q.total,I.total)+Math.abs(y)||0):I.total=B(I.total+(Math.abs(y)||0))):"group"===c?(x(y)&&(y=y[0]),null!==y&&(I.total=(I.total||0)+1)):I.total=B(I.total+(y||0));I.cumulative="group"===c?(I.total||1)-1:f(I.cumulative,m)+(y||0);null!==y&&(I.points[C].push(I.cumulative),h[t]=I.cumulative,I.hasValidPoints=!0)}"percent"===c&&(a.stacking.usePercentage=
!0);"group"!==c&&(this.stackedYData=h);a.stacking.oldStacks={}}}var m=a.getDeferredAnimation,k=y.series.prototype,r=C.addEvent,B=C.correctFloat,G=C.defined,K=C.destroyObjectProperties,I=C.fireEvent,x=C.isArray,c=C.isNumber,u=C.objectEach,f=C.pick,l=function(){function b(b){this.oldStacks={};this.stacks={};this.stacksTouched=0;this.axis=b}b.prototype.buildStacks=function(){var b=this.axis,a=b.series,c=b.options.reversedStacks,d=a.length,f;this.usePercentage=!1;for(f=d;f--;){var e=a[c?f:d-f-1];e.setStackedPoints();
e.setGroupedPoints()}for(f=0;f<d;f++)a[f].modifyStacks();I(b,"afterBuildStacks")};b.prototype.cleanStacks=function(){if(this.oldStacks)var b=this.stacks=this.oldStacks;u(b,function(b){u(b,function(b){b.cumulative=b.total})})};b.prototype.resetStacks=function(){var b=this;u(this.stacks,function(a){u(a,function(d,f){c(d.touched)&&d.touched<b.stacksTouched?(d.destroy(),delete a[f]):(d.total=null,d.cumulative=null)})})};b.prototype.renderStackTotals=function(){var b=this.axis,a=b.chart,c=a.renderer,d=
this.stacks;b=m(a,b.options.stackLabels&&b.options.stackLabels.animation||!1);var f=this.stackTotalGroup=this.stackTotalGroup||c.g("stack-labels").attr({zIndex:6,opacity:0}).add();f.translate(a.plotLeft,a.plotTop);u(d,function(b){u(b,function(b){b.render(f)})});f.animate({opacity:1},b)};return b}(),b;(function(b){var a=[];b.compose=function(b,c,f){-1===a.indexOf(b)&&(a.push(b),r(b,"init",t),r(b,"destroy",J));-1===a.indexOf(c)&&(a.push(c),c.prototype.getStacks=z);-1===a.indexOf(f)&&(a.push(f),b=f.prototype,
b.getStackIndicator=q,b.modifyStacks=n,b.percentStacker=e,b.setGroupedPoints=d,b.setStackedPoints=h)}})(b||(b={}));return b});L(g,"Series/Line/LineSeries.js",[g["Core/Series/Series.js"],g["Core/Series/SeriesRegistry.js"],g["Core/Utilities.js"]],function(a,g,y){var z=this&&this.__extends||function(){var a=function(g,q){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,e){a.__proto__=e}||function(a,e){for(var d in e)Object.prototype.hasOwnProperty.call(e,d)&&(a[d]=e[d])};return a(g,
q)};return function(g,q){function n(){this.constructor=g}if("function"!==typeof q&&null!==q)throw new TypeError("Class extends value "+String(q)+" is not a constructor or null");a(g,q);g.prototype=null===q?Object.create(q):(n.prototype=q.prototype,new n)}}(),C=y.defined,D=y.merge;y=function(g){function t(){var a=null!==g&&g.apply(this,arguments)||this;a.data=void 0;a.options=void 0;a.points=void 0;return a}z(t,g);t.prototype.drawGraph=function(){var a=this,g=this.options,e=(this.gappedPath||this.getGraphPath).call(this),
d=this.chart.styledMode,h=[["graph","highcharts-graph"]];d||h[0].push(g.lineColor||this.color||"#cccccc",g.dashStyle);h=a.getZonesGraphs(h);h.forEach(function(h,k){var m=h[0],n=a[m],q=n?"animate":"attr";n?(n.endX=a.preventGraphAnimation?null:e.xMap,n.animate({d:e})):e.length&&(a[m]=n=a.chart.renderer.path(e).addClass(h[1]).attr({zIndex:1}).add(a.group));n&&!d&&(m={stroke:h[2],"stroke-width":g.lineWidth||0,fill:a.fillGraph&&a.color||"none"},h[3]?m.dashstyle=h[3]:"square"!==g.linecap&&(m["stroke-linecap"]=
m["stroke-linejoin"]="round"),n[q](m).shadow(2>k&&g.shadow));n&&(n.startX=e.xMap,n.isArea=e.isArea)})};t.prototype.getGraphPath=function(a,g,e){var d=this,h=d.options,m=[],k=[],n,q=h.step;a=a||d.points;var t=a.reversed;t&&a.reverse();(q={right:1,center:2}[q]||q&&3)&&t&&(q=4-q);a=this.getValidPoints(a,!1,!(h.connectNulls&&!g&&!e));a.forEach(function(r,t){var x=r.plotX,c=r.plotY,u=a[t-1];(r.leftCliff||u&&u.rightCliff)&&!e&&(n=!0);r.isNull&&!C(g)&&0<t?n=!h.connectNulls:r.isNull&&!g?n=!0:(0===t||n?t=
[["M",r.plotX,r.plotY]]:d.getPointSpline?t=[d.getPointSpline(a,r,t)]:q?(t=1===q?[["L",u.plotX,c]]:2===q?[["L",(u.plotX+x)/2,u.plotY],["L",(u.plotX+x)/2,c]]:[["L",x,u.plotY]],t.push(["L",x,c])):t=[["L",x,c]],k.push(r.x),q&&(k.push(r.x),2===q&&k.push(r.x)),m.push.apply(m,t),n=!1)});m.xMap=k;return d.graphPath=m};t.prototype.getZonesGraphs=function(a){this.zones.forEach(function(g,e){e=["zone-graph-"+e,"highcharts-graph highcharts-zone-graph-"+e+" "+(g.className||"")];this.chart.styledMode||e.push(g.color||
this.color,g.dashStyle||this.options.dashStyle);a.push(e)},this);return a};t.defaultOptions=D(a.defaultOptions,{});return t}(a);g.registerSeriesType("line",y);"";return y});L(g,"Series/Area/AreaSeries.js",[g["Core/Color/Color.js"],g["Core/Legend/LegendSymbol.js"],g["Core/Series/SeriesRegistry.js"],g["Core/Utilities.js"]],function(a,g,y,E){var z=this&&this.__extends||function(){var a=function(d,e){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,d){a.__proto__=d}||function(a,d){for(var e in d)Object.prototype.hasOwnProperty.call(d,
e)&&(a[e]=d[e])};return a(d,e)};return function(d,e){function h(){this.constructor=d}if("function"!==typeof e&&null!==e)throw new TypeError("Class extends value "+String(e)+" is not a constructor or null");a(d,e);d.prototype=null===e?Object.create(e):(h.prototype=e.prototype,new h)}}(),D=a.parse,J=y.seriesTypes.line;a=E.extend;var t=E.merge,q=E.objectEach,n=E.pick;E=function(a){function d(){var d=null!==a&&a.apply(this,arguments)||this;d.data=void 0;d.options=void 0;d.points=void 0;return d}z(d,a);
d.prototype.drawGraph=function(){this.areaPath=[];a.prototype.drawGraph.apply(this);var d=this,e=this.areaPath,g=this.options,r=[["area","highcharts-area",this.color,g.fillColor]];this.zones.forEach(function(a,e){r.push(["zone-area-"+e,"highcharts-area highcharts-zone-area-"+e+" "+a.className,a.color||d.color,a.fillColor||g.fillColor])});r.forEach(function(a){var h=a[0],k={},m=d[h],r=m?"animate":"attr";m?(m.endX=d.preventGraphAnimation?null:e.xMap,m.animate({d:e})):(k.zIndex=0,m=d[h]=d.chart.renderer.path(e).addClass(a[1]).add(d.group),
m.isArea=!0);d.chart.styledMode||(k.fill=n(a[3],D(a[2]).setOpacity(n(g.fillOpacity,.75)).get()));m[r](k);m.startX=e.xMap;m.shiftUnit=g.step?2:1})};d.prototype.getGraphPath=function(a){var d=J.prototype.getGraphPath,e=this.options,h=e.stacking,g=this.yAxis,q=[],t=[],z=this.index,x=g.stacking.stacks[this.stackKey],c=e.threshold,u=Math.round(g.getThreshold(e.threshold));e=n(e.connectNulls,"percent"===h);var f=function(b,d,f){var e=a[b];b=h&&x[e.x].points[z];var l=e[f+"Null"]||0;f=e[f+"Cliff"]||0;e=!0;
if(f||l){var k=(l?b[0]:b[1])+f,m=b[0]+f;e=!!l}else!h&&a[d]&&a[d].isNull&&(k=m=c);"undefined"!==typeof k&&(t.push({plotX:A,plotY:null===k?u:g.getThreshold(k),isNull:e,isCliff:!0}),q.push({plotX:A,plotY:null===m?u:g.getThreshold(m),doCurve:!1}))};a=a||this.points;h&&(a=this.getStackPoints(a));for(var l=0,b=a.length;l<b;++l){h||(a[l].leftCliff=a[l].rightCliff=a[l].leftNull=a[l].rightNull=void 0);var v=a[l].isNull,A=n(a[l].rectPlotX,a[l].plotX),p=h?n(a[l].yBottom,u):u;if(!v||e)e||f(l,l-1,"left"),v&&!h&&
e||(t.push(a[l]),q.push({x:l,plotX:A,plotY:p})),e||f(l,l+1,"right")}f=d.call(this,t,!0,!0);q.reversed=!0;v=d.call(this,q,!0,!0);(p=v[0])&&"M"===p[0]&&(v[0]=["L",p[1],p[2]]);v=f.concat(v);v.length&&v.push(["Z"]);d=d.call(this,t,!1,e);v.xMap=f.xMap;this.areaPath=v;return d};d.prototype.getStackPoints=function(a){var d=this,e=[],h=[],g=this.xAxis,t=this.yAxis,z=t.stacking.stacks[this.stackKey],y={},x=t.series,c=x.length,u=t.options.reversedStacks?1:-1,f=x.indexOf(d);a=a||this.points;if(this.options.stacking){for(var l=
0;l<a.length;l++)a[l].leftNull=a[l].rightNull=void 0,y[a[l].x]=a[l];q(z,function(b,a){null!==b.total&&h.push(a)});h.sort(function(b,a){return b-a});var b=x.map(function(b){return b.visible});h.forEach(function(a,l){var k=0,m,r;if(y[a]&&!y[a].isNull)e.push(y[a]),[-1,1].forEach(function(e){var g=1===e?"rightNull":"leftNull",k=z[h[l+e]],n=0;if(k)for(var p=f;0<=p&&p<c;){var v=x[p].index;(m=k.points[v])||(v===d.index?y[a][g]=!0:b[p]&&(r=z[a].points[v])&&(n-=r[1]-r[0]));p+=u}y[a][1===e?"rightCliff":"leftCliff"]=
n});else{for(var v=f;0<=v&&v<c;){if(m=z[a].points[x[v].index]){k=m[1];break}v+=u}k=n(k,0);k=t.translate(k,0,1,0,1);e.push({isNull:!0,plotX:g.translate(a,0,0,0,1),x:a,plotY:k,yBottom:k})}})}return e};d.defaultOptions=t(J.defaultOptions,{threshold:0});return d}(J);a(E.prototype,{singleStacks:!1,drawLegendSymbol:g.drawRectangle});y.registerSeriesType("area",E);"";return E});L(g,"Series/Spline/SplineSeries.js",[g["Core/Series/SeriesRegistry.js"],g["Core/Utilities.js"]],function(a,g){var z=this&&this.__extends||
function(){var a=function(g,q){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,e){a.__proto__=e}||function(a,e){for(var d in e)Object.prototype.hasOwnProperty.call(e,d)&&(a[d]=e[d])};return a(g,q)};return function(g,q){function n(){this.constructor=g}if("function"!==typeof q&&null!==q)throw new TypeError("Class extends value "+String(q)+" is not a constructor or null");a(g,q);g.prototype=null===q?Object.create(q):(n.prototype=q.prototype,new n)}}(),E=a.seriesTypes.line,C=g.merge,
D=g.pick;g=function(a){function g(){var g=null!==a&&a.apply(this,arguments)||this;g.data=void 0;g.options=void 0;g.points=void 0;return g}z(g,a);g.prototype.getPointSpline=function(a,g,e){var d=g.plotX||0,h=g.plotY||0,m=a[e-1];e=a[e+1];if(m&&!m.isNull&&!1!==m.doCurve&&!g.isCliff&&e&&!e.isNull&&!1!==e.doCurve&&!g.isCliff){a=m.plotY||0;var k=e.plotX||0;e=e.plotY||0;var n=0,q=(1.5*d+(m.plotX||0))/2.5,t=(1.5*h+a)/2.5;k=(1.5*d+k)/2.5;var z=(1.5*h+e)/2.5;k!==q&&(n=(z-t)*(k-d)/(k-q)+h-z);t+=n;z+=n;t>a&&
t>h?(t=Math.max(a,h),z=2*h-t):t<a&&t<h&&(t=Math.min(a,h),z=2*h-t);z>e&&z>h?(z=Math.max(e,h),t=2*h-z):z<e&&z<h&&(z=Math.min(e,h),t=2*h-z);g.rightContX=k;g.rightContY=z}g=["C",D(m.rightContX,m.plotX,0),D(m.rightContY,m.plotY,0),D(q,d,0),D(t,h,0),d,h];m.rightContX=m.rightContY=void 0;return g};g.defaultOptions=C(E.defaultOptions);return g}(E);a.registerSeriesType("spline",g);"";return g});L(g,"Series/AreaSpline/AreaSplineSeries.js",[g["Series/Spline/SplineSeries.js"],g["Core/Legend/LegendSymbol.js"],
g["Core/Series/SeriesRegistry.js"],g["Core/Utilities.js"]],function(a,g,y,E){var z=this&&this.__extends||function(){var a=function(e,d){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,d){a.__proto__=d}||function(a,d){for(var e in d)Object.prototype.hasOwnProperty.call(d,e)&&(a[e]=d[e])};return a(e,d)};return function(e,d){function g(){this.constructor=e}if("function"!==typeof d&&null!==d)throw new TypeError("Class extends value "+String(d)+" is not a constructor or null");a(e,
d);e.prototype=null===d?Object.create(d):(g.prototype=d.prototype,new g)}}(),D=y.seriesTypes,J=D.area;D=D.area.prototype;var t=E.extend,q=E.merge;E=function(g){function e(){var a=null!==g&&g.apply(this,arguments)||this;a.data=void 0;a.points=void 0;a.options=void 0;return a}z(e,g);e.defaultOptions=q(a.defaultOptions,J.defaultOptions);return e}(a);t(E.prototype,{getGraphPath:D.getGraphPath,getStackPoints:D.getStackPoints,drawGraph:D.drawGraph,drawLegendSymbol:g.drawRectangle});y.registerSeriesType("areaspline",
E);"";return E});L(g,"Series/Column/ColumnSeriesDefaults.js",[],function(){"";return{borderRadius:0,centerInCategory:!1,groupPadding:.2,marker:null,pointPadding:.1,minPointLength:0,cropThreshold:50,pointRange:null,states:{hover:{halo:!1,brightness:.1},select:{color:"#cccccc",borderColor:"#000000"}},dataLabels:{align:void 0,verticalAlign:void 0,y:void 0},startFromThreshold:!0,stickyTracking:!1,tooltip:{distance:6},threshold:0,borderColor:"#ffffff"}});L(g,"Series/Column/ColumnSeries.js",[g["Core/Animation/AnimationUtilities.js"],
g["Core/Color/Color.js"],g["Series/Column/ColumnSeriesDefaults.js"],g["Core/Globals.js"],g["Core/Legend/LegendSymbol.js"],g["Core/Series/Series.js"],g["Core/Series/SeriesRegistry.js"],g["Core/Utilities.js"]],function(a,g,y,E,C,D,J,t){var q=this&&this.__extends||function(){var a=function(c,d){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,b){a.__proto__=b}||function(a,b){for(var c in b)Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c])};return a(c,d)};return function(c,d){function e(){this.constructor=
c}if("function"!==typeof d&&null!==d)throw new TypeError("Class extends value "+String(d)+" is not a constructor or null");a(c,d);c.prototype=null===d?Object.create(d):(e.prototype=d.prototype,new e)}}(),n=a.animObject,e=g.parse,d=E.hasTouch;a=E.noop;var h=t.clamp,m=t.defined,k=t.extend,r=t.fireEvent,z=t.isArray,G=t.isNumber,K=t.merge,I=t.pick,x=t.objectEach;t=function(a){function c(){var c=null!==a&&a.apply(this,arguments)||this;c.borderWidth=void 0;c.data=void 0;c.group=void 0;c.options=void 0;
c.points=void 0;return c}q(c,a);c.prototype.animate=function(a){var c=this,b=this.yAxis,d=c.options,e=this.chart.inverted,f={},g=e?"translateX":"translateY";if(a)f.scaleY=.001,a=h(b.toPixels(d.threshold),b.pos,b.pos+b.len),e?f.translateX=a-b.len:f.translateY=a,c.clipBox&&c.setClip(),c.group.attr(f);else{var m=Number(c.group.attr(g));c.group.animate({scaleY:1},k(n(c.options.animation),{step:function(a,d){c.group&&(f[g]=m+d.pos*(b.pos-m),c.group.attr(f))}}))}};c.prototype.init=function(c,d){a.prototype.init.apply(this,
arguments);var b=this;c=b.chart;c.hasRendered&&c.series.forEach(function(a){a.type===b.type&&(a.isDirty=!0)})};c.prototype.getColumnMetrics=function(){var a=this,c=a.options,b=a.xAxis,d=a.yAxis,e=b.options.reversedStacks;e=b.reversed&&!e||!b.reversed&&e;var g={},h,k=0;!1===c.grouping?k=1:a.chart.series.forEach(function(b){var c=b.yAxis,e=b.options;if(b.type===a.type&&(b.visible||!a.chart.options.chart.ignoreHiddenSeries)&&d.len===c.len&&d.pos===c.pos){if(e.stacking&&"group"!==e.stacking){h=b.stackKey;
"undefined"===typeof g[h]&&(g[h]=k++);var f=g[h]}else!1!==e.grouping&&(f=k++);b.columnIndex=f}});var m=Math.min(Math.abs(b.transA)*(b.ordinal&&b.ordinal.slope||c.pointRange||b.closestPointRange||b.tickInterval||1),b.len),n=m*c.groupPadding,r=(m-2*n)/(k||1);c=Math.min(c.maxPointWidth||b.len,I(c.pointWidth,r*(1-2*c.pointPadding)));a.columnMetrics={width:c,offset:(r-c)/2+(n+((a.columnIndex||0)+(e?1:0))*r-m/2)*(e?-1:1),paddedWidth:r,columnCount:k};return a.columnMetrics};c.prototype.crispCol=function(a,
c,b,d){var e=this.chart,f=this.borderWidth,g=-(f%2?.5:0);f=f%2?.5:1;e.inverted&&e.renderer.isVML&&(f+=1);this.options.crisp&&(b=Math.round(a+b)+g,a=Math.round(a)+g,b-=a);d=Math.round(c+d)+f;g=.5>=Math.abs(c)&&.5<d;c=Math.round(c)+f;d-=c;g&&d&&(--c,d+=1);return{x:a,y:c,width:b,height:d}};c.prototype.adjustForMissingColumns=function(a,c,b,d){var e=this,f=this.options.stacking;if(!b.isNull&&1<d.columnCount){var g=this.yAxis.options.reversedStacks,h=0,l=g?0:-d.columnCount;x(this.yAxis.stacking&&this.yAxis.stacking.stacks,
function(a){if("number"===typeof b.x){var c=a[b.x.toString()];c&&(a=c.points[e.index],f?(a&&(h=l),c.hasValidPoints&&(g?l++:l--)):z(a)&&(a=Object.keys(c.points).filter(function(b){return!b.match(",")&&c.points[b]&&1<c.points[b].length}).map(parseFloat).sort(function(b,a){return a-b}),h=a.indexOf(e.index),l=a.length))}});a=(b.plotX||0)+((l-1)*d.paddedWidth+c)/2-c-h*d.paddedWidth}return a};c.prototype.translate=function(){var a=this,c=a.chart,b=a.options,d=a.dense=2>a.closestPointRange*a.xAxis.transA;
d=a.borderWidth=I(b.borderWidth,d?0:1);var e=a.xAxis,g=a.yAxis,k=b.threshold,n=a.translatedThreshold=g.getThreshold(k),r=I(b.minPointLength,5),u=a.getColumnMetrics(),q=u.width,x=a.pointXOffset=u.offset,w=a.dataMin,t=a.dataMax,z=a.barW=Math.max(q,1+2*d);c.inverted&&(n-=.5);b.pointPadding&&(z=Math.ceil(z));D.prototype.translate.apply(a);a.points.forEach(function(d){var f=I(d.yBottom,n),l=999+Math.abs(f),p=d.plotX||0;l=h(d.plotY,-l,g.len+l);var v=Math.min(l,f),A=Math.max(l,f)-v,B=q,y=p+x,F=z;r&&Math.abs(A)<
r&&(A=r,p=!g.reversed&&!d.negative||g.reversed&&d.negative,G(k)&&G(t)&&d.y===k&&t<=k&&(g.min||0)<k&&(w!==t||(g.max||0)<=k)&&(p=!p),v=Math.abs(v-n)>r?f-r:n-(p?r:0));m(d.options.pointWidth)&&(B=F=Math.ceil(d.options.pointWidth),y-=Math.round((B-q)/2));b.centerInCategory&&(y=a.adjustForMissingColumns(y,B,d,u));d.barX=y;d.pointWidth=B;d.tooltipPos=c.inverted?[h(g.len+g.pos-c.plotLeft-l,g.pos-c.plotLeft,g.len+g.pos-c.plotLeft),e.len+e.pos-c.plotTop-y-F/2,A]:[e.left-c.plotLeft+y+F/2,h(l+g.pos-c.plotTop,
g.pos-c.plotTop,g.len+g.pos-c.plotTop),A];d.shapeType=a.pointClass.prototype.shapeType||"rect";d.shapeArgs=a.crispCol.apply(a,d.isNull?[y,n,F,0]:[y,v,F,A])})};c.prototype.drawGraph=function(){this.group[this.dense?"addClass":"removeClass"]("highcharts-dense-data")};c.prototype.pointAttribs=function(a,c){var b=this.options,d=this.pointAttrToOptions||{},f=d.stroke||"borderColor",g=d["stroke-width"]||"borderWidth",h=a&&a.color||this.color,l=a&&a[f]||b[f]||h;d=a&&a.options.dashStyle||b.dashStyle;var k=
a&&a[g]||b[g]||this[g]||0,m=I(a&&a.opacity,b.opacity,1);if(a&&this.zones.length){var n=a.getZone();h=a.options.color||n&&(n.color||a.nonZonedColor)||this.color;n&&(l=n.borderColor||l,d=n.dashStyle||d,k=n.borderWidth||k)}c&&a&&(a=K(b.states[c],a.options.states&&a.options.states[c]||{}),c=a.brightness,h=a.color||"undefined"!==typeof c&&e(h).brighten(a.brightness).get()||h,l=a[f]||l,k=a[g]||k,d=a.dashStyle||d,m=I(a.opacity,m));f={fill:h,stroke:l,"stroke-width":k,opacity:m};d&&(f.dashstyle=d);return f};
...
"afterDrawTracker")};c.prototype.remove=function(){var a=this,c=a.chart;c.hasRendered&&c.series.forEach(function(b){b.type===a.type&&(b.isDirty=!0)});D.prototype.remove.apply(a,arguments)};c.defaultOptions=K(D.defaultOptions,y);return c}(D);k(t.prototype,{cropShoulder:0,directTouch:!0,drawLegendSymbol:C.drawRectangle,getSymbol:a,negStacks:!0,trackerGroups:["group","dataLabelsGroup"]});J.registerSeriesType("column",t);"";return t});L(g,"Core/Series/DataLabel.js",[g["Core/Animation/AnimationUtilities.js"],
g["Core/FormatUtilities.js"],g["Core/Utilities.js"]],function(a,g,y){var z=a.getDeferredAnimation,C=g.format,D=y.defined,J=y.extend,t=y.fireEvent,q=y.isArray,n=y.isString,e=y.merge,d=y.objectEach,h=y.pick,m=y.splat,k;(function(a){function g(a,c,b,d,e){var f=this,g=this.chart,l=this.isCartesian&&g.inverted,k=this.enabledDataSorting,m=a.plotX,n=a.plotY,r=b.rotation,u=b.align,q=D(m)&&D(n)&&g.isInsidePlot(m,Math.round(n),{inverted:l,paneCoordinates:!0,series:f});n=function(b){k&&f.xAxis&&!v&&f.setDataLabelStartPos(a,
c,e,q,b)};var v="justify"===h(b.overflow,k?"none":"justify");m=this.visible&&!1!==a.visible&&D(m)&&(a.series.forceDL||k&&!v||q||h(b.inside,!!this.options.stacking)&&d&&g.isInsidePlot(m,l?d.x+1:d.y+d.height-1,{inverted:l,paneCoordinates:!0,series:f}));l=a.pos();if(m&&l){r&&c.attr({align:u});u=c.getBBox(!0);var x=[0,0],t=g.renderer.fontMetrics(g.styledMode?void 0:b.style.fontSize,c).b;d=J({x:l[0],y:Math.round(l[1]),width:0,height:0},d);J(b,{width:u.width,height:u.height});r?(v=!1,x=g.renderer.rotCorr(t,
r),t={x:d.x+(b.x||0)+d.width/2+x.x,y:d.y+(b.y||0)+{top:0,middle:.5,bottom:1}[b.verticalAlign]*d.height},x=[u.x-Number(c.attr("x")),u.y-Number(c.attr("y"))],n(t),c[e?"attr":"animate"](t)):(n(d),c.align(b,void 0,d),t=c.alignAttr);v&&0<=d.height?this.justifyDataLabel(c,b,t,u,d,e):h(b.crop,!0)&&(d=t.x,n=t.y,d+=x[0],n+=x[1],m=g.isInsidePlot(d,n,{paneCoordinates:!0,series:f})&&g.isInsidePlot(d+u.width,n+u.height,{paneCoordinates:!0,series:f}));if(b.shape&&!r)c[e?"attr":"animate"]({anchorX:l[0],anchorY:l[1]})}e&&
k&&(c.placed=!1);m||k&&!v?c.show():(c.hide(),c.placed=!1)}function k(a,c){var b=c.filter;return b?(c=b.operator,a=a[b.property],b=b.value,"\x3e"===c&&a>b||"\x3c"===c&&a<b||"\x3e\x3d"===c&&a>=b||"\x3c\x3d"===c&&a<=b||"\x3d\x3d"===c&&a==b||"\x3d\x3d\x3d"===c&&a===b?!0:!1):!0}function r(a){void 0===a&&(a=this.points);var c=this,b=c.chart,e=c.options,f=c.hasRendered||0,g=b.renderer,r=b.options.chart,u=r.backgroundColor;r=r.plotBackgroundColor;var y=g.getContrast(n(r)&&r||n(u)&&u||"#000000"),B=e.dataLabels,
G;u=B.animation;u=B.defer?z(b,u,c):{defer:0,duration:0};B=x(x(b.options.plotOptions&&b.options.plotOptions.series&&b.options.plotOptions.series.dataLabels,b.options.plotOptions&&b.options.plotOptions[c.type]&&b.options.plotOptions[c.type].dataLabels),B);t(this,"drawDataLabels");if(q(B)||B.enabled||c._hasPointLabels){var I=c.plotGroup("dataLabelsGroup","data-labels",f?"inherit":"hidden",B.zIndex||6);I.attr({opacity:+f});!f&&(f=c.dataLabelsGroup)&&(c.visible&&I.show(),f[e.animation?"animate":"attr"]({opacity:1},
u));a.forEach(function(a){G=m(x(B,a.dlOptions||a.options&&a.options.dataLabels));G.forEach(function(f,l){var m=f.enabled&&(!a.isNull||a.dataLabelOnNull)&&k(a,f),n=a.connectors?a.connectors[l]:a.connector,p=a.dataLabels?a.dataLabels[l]:a.dataLabel,r=!p,u=h(f.distance,a.labelDistance);if(m){var q=a.getLabelConfig(),v=h(f[a.formatPrefix+"Format"],f.format);q=D(v)?C(v,q,b):(f[a.formatPrefix+"Formatter"]||f.formatter).call(q,f);v=f.style;var x=f.rotation;b.styledMode||(v.color=h(f.color,v.color,c.color,
"#000000"),"contrast"===v.color?(a.contrastColor=g.getContrast(a.color||c.color),v.color=!D(u)&&f.inside||0>u||e.stacking?a.contrastColor:y):delete a.contrastColor,e.cursor&&(v.cursor=e.cursor));var t={r:f.borderRadius||0,rotation:x,padding:f.padding,zIndex:1};if(!b.styledMode){u=f.backgroundColor;var w=f.borderColor;t.fill="auto"===u?a.color:u;t.stroke="auto"===w?a.color:w;t["stroke-width"]=f.borderWidth}d(t,function(a,b){"undefined"===typeof a&&delete t[b]})}!p||m&&D(q)&&!!p.div===!!f.useHTML&&
(p.rotation&&f.rotation||p.rotation===f.rotation)||(r=!0,a.dataLabel=p=a.dataLabel&&a.dataLabel.destroy(),a.dataLabels&&(1===a.dataLabels.length?delete a.dataLabels:delete a.dataLabels[l]),l||delete a.dataLabel,n&&(a.connector=a.connector.destroy(),a.connectors&&(1===a.connectors.length?delete a.connectors:delete a.connectors[l])));m&&D(q)?(p?t.text=q:(a.dataLabels=a.dataLabels||[],p=a.dataLabels[l]=x?g.text(q,0,0,f.useHTML).addClass("highcharts-data-label"):g.label(q,0,0,f.shape,null,null,f.useHTML,
...
function y(a,c,b,d,e,g){var f=this.chart,h=c.align,k=c.verticalAlign,l=a.box?0:a.padding||0,m=c.x;m=void 0===m?0:m;var n=c.y;n=void 0===n?0:n;var p=(b.x||0)+l;if(0>p){"right"===h&&0<=m?(c.align="left",c.inside=!0):m-=p;var r=!0}p=(b.x||0)+d.width-l;p>f.plotWidth&&("left"===h&&0>=m?(c.align="right",c.inside=!0):m+=f.plotWidth-p,r=!0);p=b.y+l;0>p&&("bottom"===k&&0<=n?(c.verticalAlign="top",c.inside=!0):n-=p,r=!0);p=(b.y||0)+d.height-l;p>f.plotHeight&&("top"===k&&0>=n?(c.verticalAlign="bottom",c.inside=
!0):n+=f.plotHeight-p,r=!0);r&&(c.x=m,c.y=n,a.placed=!g,a.align(c,void 0,e));return r}function x(a,c){var b=[],d;if(q(a)&&!q(c))b=a.map(function(a){return e(a,c)});else if(q(c)&&!q(a))b=c.map(function(b){return e(a,b)});else if(q(a)||q(c))for(d=Math.max(a.length,c.length);d--;)b[d]=e(a[d],c[d]);else b=e(a,c);return b}function c(a,c,b,d,e){var f=this.chart,g=f.inverted,h=this.xAxis,k=h.reversed,l=g?c.height/2:c.width/2;a=(a=a.pointWidth)?a/2:0;c.startXPos=g?e.x:k?-l-a:h.width-l+a;c.startYPos=g?k?this.yAxis.height-
l+a:-l-a:e.y;d?"hidden"===c.visibility&&(c.show(),c.attr({opacity:0}).animate({opacity:1})):c.attr({opacity:1}).animate({opacity:0},void 0,c.hide);f.hasRendered&&(b&&c.attr({x:c.startXPos,y:c.startYPos}),c.placed=!0)}var u=[];a.compose=function(a){if(-1===u.indexOf(a)){var d=a.prototype;u.push(a);d.alignDataLabel=g;d.drawDataLabels=r;d.justifyDataLabel=y;d.setDataLabelStartPos=c}}})(k||(k={}));"";return k});L(g,"Series/Column/ColumnDataLabel.js",[g["Core/Series/DataLabel.js"],g["Core/Series/SeriesRegistry.js"],
g["Core/Utilities.js"]],function(a,g,y){var z=g.series,C=y.merge,D=y.pick,J;(function(g){function q(a,d,g,m,k){var e=this.chart.inverted,h=a.series,n=(h.xAxis?h.xAxis.len:this.chart.plotSizeX)||0;h=(h.yAxis?h.yAxis.len:this.chart.plotSizeY)||0;var q=a.dlBox||a.shapeArgs,t=D(a.below,a.plotY>D(this.translatedThreshold,h)),x=D(g.inside,!!this.options.stacking);q&&(m=C(q),0>m.y&&(m.height+=m.y,m.y=0),q=m.y+m.height-h,0<q&&q<m.height&&(m.height-=q),e&&(m={x:h-m.y-m.height,y:n-m.x-m.width,width:m.height,
height:m.width}),x||(e?(m.x+=t?0:m.width,m.width=0):(m.y+=t?m.height:0,m.height=0)));g.align=D(g.align,!e||x?"center":t?"right":"left");g.verticalAlign=D(g.verticalAlign,e||x?"middle":t?"top":"bottom");z.prototype.alignDataLabel.call(this,a,d,g,m,k);g.inside&&a.contrastColor&&d.css({color:a.contrastColor})}var n=[];g.compose=function(e){a.compose(z);-1===n.indexOf(e)&&(n.push(e),e.prototype.alignDataLabel=q)}})(J||(J={}));return J});L(g,"Series/Bar/BarSeries.js",[g["Series/Column/ColumnSeries.js"],
g["Core/Series/SeriesRegistry.js"],g["Core/Utilities.js"]],function(a,g,y){var z=this&&this.__extends||function(){var a=function(g,q){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,e){a.__proto__=e}||function(a,e){for(var d in e)Object.prototype.hasOwnProperty.call(e,d)&&(a[d]=e[d])};return a(g,q)};return function(g,q){function n(){this.constructor=g}if("function"!==typeof q&&null!==q)throw new TypeError("Class extends value "+String(q)+" is not a constructor or null");a(g,q);
g.prototype=null===q?Object.create(q):(n.prototype=q.prototype,new n)}}(),C=y.extend,D=y.merge;y=function(g){function t(){var a=null!==g&&g.apply(this,arguments)||this;a.data=void 0;a.options=void 0;a.points=void 0;return a}z(t,g);t.defaultOptions=D(a.defaultOptions,{});return t}(a);C(y.prototype,{inverted:!0});g.registerSeriesType("bar",y);"";return y});L(g,"Series/Scatter/ScatterSeriesDefaults.js",[],function(){"";return{lineWidth:0,findNearestPointBy:"xy",jitter:{x:0,y:0},marker:{enabled:!0},tooltip:{headerFormat:'\x3cspan style\x3d"color:{point.color}"\x3e\u25cf\x3c/span\x3e \x3cspan style\x3d"font-size: 10px"\x3e {series.name}\x3c/span\x3e\x3cbr/\x3e',
pointFormat:"x: \x3cb\x3e{point.x}\x3c/b\x3e\x3cbr/\x3ey: \x3cb\x3e{point.y}\x3c/b\x3e\x3cbr/\x3e"}}});L(g,"Series/Scatter/ScatterSeries.js",[g["Series/Scatter/ScatterSeriesDefaults.js"],g["Core/Series/SeriesRegistry.js"],g["Core/Utilities.js"]],function(a,g,y){var z=this&&this.__extends||function(){var a=function(e,d){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,d){a.__proto__=d}||function(a,d){for(var e in d)Object.prototype.hasOwnProperty.call(d,e)&&(a[e]=d[e])};return a(e,
d)};return function(e,d){function g(){this.constructor=e}if("function"!==typeof d&&null!==d)throw new TypeError("Class extends value "+String(d)+" is not a constructor or null");a(e,d);e.prototype=null===d?Object.create(d):(g.prototype=d.prototype,new g)}}(),C=g.seriesTypes,D=C.column,J=C.line;C=y.addEvent;var t=y.extend,q=y.merge;y=function(g){function e(){var a=null!==g&&g.apply(this,arguments)||this;a.data=void 0;a.options=void 0;a.points=void 0;return a}z(e,g);e.prototype.applyJitter=function(){var a=
this,e=this.options.jitter,g=this.points.length;e&&this.points.forEach(function(d,h){["x","y"].forEach(function(k,m){var n="plot"+k.toUpperCase();if(e[k]&&!d.isNull){var r=a[k+"Axis"],q=e[k]*r.transA;if(r&&!r.isLog){var c=Math.max(0,d[n]-q);r=Math.min(r.len,d[n]+q);m=1E4*Math.sin(h+m*g);d[n]=c+(r-c)*(m-Math.floor(m));"x"===k&&(d.clientX=d.plotX)}}})})};e.prototype.drawGraph=function(){this.options.lineWidth?g.prototype.drawGraph.call(this):this.graph&&(this.graph=this.graph.destroy())};e.defaultOptions=
q(J.defaultOptions,a);return e}(J);t(y.prototype,{drawTracker:D.prototype.drawTracker,sorted:!1,requireSorting:!1,noSharedTooltip:!0,trackerGroups:["group","markerGroup","dataLabelsGroup"],takeOrdinalPosition:!1});C(y,"afterTranslate",function(){this.applyJitter()});g.registerSeriesType("scatter",y);return y});L(g,"Series/CenteredUtilities.js",[g["Core/Globals.js"],g["Core/Series/Series.js"],g["Core/Utilities.js"]],function(a,g,y){var z=a.deg2rad,C=y.fireEvent,D=y.isNumber,J=y.pick,t=y.relativeLength,
q;(function(a){a.getCenter=function(){var a=this.options,d=this.chart,h=2*(a.slicedOffset||0),m=d.plotWidth-2*h,k=d.plotHeight-2*h,n=a.center,q=Math.min(m,k),z=a.thickness,y=a.size,I=a.innerSize||0;"string"===typeof y&&(y=parseFloat(y));"string"===typeof I&&(I=parseFloat(I));a=[J(n[0],"50%"),J(n[1],"50%"),J(y&&0>y?void 0:a.size,"100%"),J(I&&0>I?void 0:a.innerSize||0,"0%")];!d.angular||this instanceof g||(a[3]=0);for(n=0;4>n;++n)y=a[n],d=2>n||2===n&&/%$/.test(y),a[n]=t(y,[m,k,q,a[2]][n])+(d?h:0);a[3]>
a[2]&&(a[3]=a[2]);D(z)&&2*z<a[2]&&0<z&&(a[3]=a[2]-2*z);C(this,"afterGetCenter",{positions:a});return a};a.getStartAndEndRadians=function(a,d){a=D(a)?a:0;d=D(d)&&d>a&&360>d-a?d:a+360;return{start:z*(a+-90),end:z*(d+-90)}}})(q||(q={}));"";return q});L(g,"Series/Pie/PiePoint.js",[g["Core/Animation/AnimationUtilities.js"],g["Core/Series/Point.js"],g["Core/Utilities.js"]],function(a,g,y){var z=this&&this.__extends||function(){var a=function(d,e){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&
function(a,d){a.__proto__=d}||function(a,d){for(var e in d)Object.prototype.hasOwnProperty.call(d,e)&&(a[e]=d[e])};return a(d,e)};return function(d,e){function g(){this.constructor=d}if("function"!==typeof e&&null!==e)throw new TypeError("Class extends value "+String(e)+" is not a constructor or null");a(d,e);d.prototype=null===e?Object.create(e):(g.prototype=e.prototype,new g)}}(),C=a.setAnimation,D=y.addEvent,J=y.defined;a=y.extend;var t=y.isNumber,q=y.pick,n=y.relativeLength;g=function(a){function d(){var d=
null!==a&&a.apply(this,arguments)||this;d.labelDistance=void 0;d.options=void 0;d.series=void 0;return d}z(d,a);d.prototype.getConnectorPath=function(){var a=this.labelPosition,d=this.series.options.dataLabels,e=this.connectorShapes,g=d.connectorShape;e[g]&&(g=e[g]);return g.call(this,{x:a.final.x,y:a.final.y,alignment:a.alignment},a.connectorPosition,d)};d.prototype.getTranslate=function(){return this.sliced?this.slicedTranslation:{translateX:0,translateY:0}};d.prototype.haloPath=function(a){var d=
this.shapeArgs;return this.sliced||!this.visible?[]:this.series.chart.renderer.symbols.arc(d.x,d.y,d.r+a,d.r+a,{innerR:d.r-1,start:d.start,end:d.end})};d.prototype.init=function(){var d=this;a.prototype.init.apply(this,arguments);this.name=q(this.name,"Slice");var e=function(a){d.slice("select"===a.type)};D(this,"select",e);D(this,"unselect",e);return this};d.prototype.isValid=function(){return t(this.y)&&0<=this.y};d.prototype.setVisible=function(a,d){var e=this,g=this.series,h=g.chart,m=g.options.ignoreHiddenPoint;
d=q(d,m);a!==this.visible&&(this.visible=this.options.visible=a="undefined"===typeof a?!this.visible:a,g.options.data[g.data.indexOf(this)]=this.options,["graphic","dataLabel","connector","shadowGroup"].forEach(function(d){if(e[d])e[d][a?"show":"hide"](a)}),this.legendItem&&h.legend.colorizeItem(this,a),a||"hover"!==this.state||this.setState(""),m&&(g.isDirty=!0),d&&h.redraw())};d.prototype.slice=function(a,d,e){var g=this.series;C(e,g.chart);q(d,!0);this.sliced=this.options.sliced=J(a)?a:!this.sliced;
...
d,g){d=d.touchingSliceAt;var e=this.series,h=e.center[0],r=e.chart.plotWidth,q=e.chart.plotLeft;e=a.alignment;var t=this.shapeArgs.r;g=n(g.crookDistance,1);r="left"===e?h+t+(r+q-h-t)*(1-g):q+(h-t)*g;g=["L",r,a.y];h=!0;if("left"===e?r>a.x||r<d.x:r<a.x||r>d.x)h=!1;a=[["M",a.x,a.y]];h&&a.push(g);a.push(["L",d.x,d.y]);return a}}});return g});L(g,"Series/Pie/PieSeriesDefaults.js",[],function(){"";return{center:[null,null],clip:!1,colorByPoint:!0,dataLabels:{allowOverlap:!0,connectorPadding:5,connectorShape:"fixedOffset",
crookDistance:"70%",distance:30,enabled:!0,formatter:function(){return this.point.isNull?void 0:this.point.name},softConnector:!0,x:0},fillColor:void 0,ignoreHiddenPoint:!0,inactiveOtherPoints:!0,legendType:"point",marker:null,size:null,showInLegend:!1,slicedOffset:10,stickyTracking:!1,tooltip:{followPointer:!0},borderColor:"#ffffff",borderWidth:1,lineWidth:void 0,states:{hover:{brightness:.1}}}});L(g,"Series/Pie/PieSeries.js",[g["Series/CenteredUtilities.js"],g["Series/Column/ColumnSeries.js"],g["Core/Globals.js"],
g["Core/Legend/LegendSymbol.js"],g["Series/Pie/PiePoint.js"],g["Series/Pie/PieSeriesDefaults.js"],g["Core/Series/Series.js"],g["Core/Series/SeriesRegistry.js"],g["Core/Renderer/SVG/Symbols.js"],g["Core/Utilities.js"]],function(a,g,y,E,C,D,J,t,q,n){var e=this&&this.__extends||function(){var a=function(d,e){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,d){a.__proto__=d}||function(a,d){for(var c in d)Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])};return a(d,e)};return function(d,
e){function c(){this.constructor=d}if("function"!==typeof e&&null!==e)throw new TypeError("Class extends value "+String(e)+" is not a constructor or null");a(d,e);d.prototype=null===e?Object.create(e):(c.prototype=e.prototype,new c)}}(),d=a.getStartAndEndRadians;y=y.noop;var h=n.clamp,m=n.extend,k=n.fireEvent,r=n.merge,z=n.pick,G=n.relativeLength;n=function(a){function g(){var d=null!==a&&a.apply(this,arguments)||this;d.center=void 0;d.data=void 0;d.maxLabelDistance=void 0;d.options=void 0;d.points=
void 0;return d}e(g,a);g.prototype.animate=function(a){var c=this,d=c.points,e=c.startAngleRad;a||d.forEach(function(a){var b=a.graphic,d=a.shapeArgs;b&&d&&(b.attr({r:z(a.startR,c.center&&c.center[3]/2),start:e,end:e}),b.animate({r:d.r,start:d.start,end:d.end},c.options.animation))})};g.prototype.drawEmpty=function(){var a=this.startAngleRad,c=this.endAngleRad,d=this.options;if(0===this.total&&this.center){var e=this.center[0],g=this.center[1];this.graph||(this.graph=this.chart.renderer.arc(e,g,this.center[1]/
2,0,a,c).addClass("highcharts-empty-series").add(this.group));this.graph.attr({d:q.arc(e,g,this.center[2]/2,0,{start:a,end:c,innerR:this.center[3]/2})});this.chart.styledMode||this.graph.attr({"stroke-width":d.borderWidth,fill:d.fillColor||"none",stroke:d.color||"#cccccc"})}else this.graph&&(this.graph=this.graph.destroy())};g.prototype.drawPoints=function(){var a=this.chart.renderer;this.points.forEach(function(c){c.graphic&&c.hasNewShapeType()&&(c.graphic=c.graphic.destroy());c.graphic||(c.graphic=
a[c.shapeType](c.shapeArgs).add(c.series.group),c.delayedRendering=!0)})};g.prototype.generatePoints=function(){a.prototype.generatePoints.call(this);this.updateTotals()};g.prototype.getX=function(a,c,d){var e=this.center,g=this.radii?this.radii[d.index]||0:e[2]/2;a=Math.asin(h((a-e[1])/(g+d.labelDistance),-1,1));return e[0]+(c?-1:1)*Math.cos(a)*(g+d.labelDistance)+(0<d.labelDistance?(c?-1:1)*this.options.dataLabels.padding:0)};g.prototype.hasData=function(){return!!this.processedXData.length};g.prototype.redrawPoints=
function(){var a=this,c=a.chart,d=c.renderer,e=a.options.shadow,g,b,h,k;this.drawEmpty();!e||a.shadowGroup||c.styledMode||(a.shadowGroup=d.g("shadow").attr({zIndex:-1}).add(a.group));a.points.forEach(function(f){var l={};b=f.graphic;if(!f.isNull&&b){var m=void 0;k=f.shapeArgs;g=f.getTranslate();c.styledMode||(m=f.shadowGroup,e&&!m&&(m=f.shadowGroup=d.g("shadow").add(a.shadowGroup)),m&&m.attr(g),h=a.pointAttribs(f,f.selected&&"select"));f.delayedRendering?(b.setRadialReference(a.center).attr(k).attr(g),
c.styledMode||b.attr(h).attr({"stroke-linejoin":"round"}).shadow(e,m),f.delayedRendering=!1):(b.setRadialReference(a.center),c.styledMode||r(!0,l,h),r(!0,l,k,g),b.animate(l));b.attr({visibility:f.visible?"inherit":"hidden"});b.addClass(f.getClassName(),!0)}else b&&(f.graphic=b.destroy())})};g.prototype.sortByAngle=function(a,c){a.sort(function(a,d){return"undefined"!==typeof a.angle&&(d.angle-a.angle)*c})};g.prototype.translate=function(a){k(this,"translate");this.generatePoints();var c=this.options,
e=c.slicedOffset,f=e+(c.borderWidth||0),g=d(c.startAngle,c.endAngle),b=this.startAngleRad=g.start;g=(this.endAngleRad=g.end)-b;var h=this.points,m=c.dataLabels.distance;c=c.ignoreHiddenPoint;var n=h.length,r,q=0;a||(this.center=a=this.getCenter());for(r=0;r<n;r++){var t=h[r],x=b+q*g;!t.isValid()||c&&!t.visible||(q+=t.percentage/100);var y=b+q*g,B={x:a[0],y:a[1],r:a[2]/2,innerR:a[3]/2,start:Math.round(1E3*x)/1E3,end:Math.round(1E3*y)/1E3};t.shapeType="arc";t.shapeArgs=B;t.labelDistance=z(t.options.dataLabels&&
t.options.dataLabels.distance,m);t.labelDistance=G(t.labelDistance,B.r);this.maxLabelDistance=Math.max(this.maxLabelDistance||0,t.labelDistance);y=(y+x)/2;y>1.5*Math.PI?y-=2*Math.PI:y<-Math.PI/2&&(y+=2*Math.PI);t.slicedTranslation={translateX:Math.round(Math.cos(y)*e),translateY:Math.round(Math.sin(y)*e)};B=Math.cos(y)*a[2]/2;var w=Math.sin(y)*a[2]/2;t.tooltipPos=[a[0]+.7*B,a[1]+.7*w];t.half=y<-Math.PI/2||y>Math.PI/2?1:0;t.angle=y;x=Math.min(f,t.labelDistance/5);t.labelPosition={natural:{x:a[0]+B+
Math.cos(y)*t.labelDistance,y:a[1]+w+Math.sin(y)*t.labelDistance},"final":{},alignment:0>t.labelDistance?"center":t.half?"right":"left",connectorPosition:{breakAt:{x:a[0]+B+Math.cos(y)*x,y:a[1]+w+Math.sin(y)*x},touchingSliceAt:{x:a[0]+B,y:a[1]+w}}}}k(this,"afterTranslate")};g.prototype.updateTotals=function(){var a=this.points,c=a.length,d=this.options.ignoreHiddenPoint,e,g=0;for(e=0;e<c;e++){var b=a[e];!b.isValid()||d&&!b.visible||(g+=b.y)}this.total=g;for(e=0;e<c;e++)b=a[e],b.percentage=0<g&&(b.visible||
!d)?b.y/g*100:0,b.total=g};g.defaultOptions=r(J.defaultOptions,D);return g}(J);m(n.prototype,{axisTypes:[],directTouch:!0,drawGraph:void 0,drawLegendSymbol:E.drawRectangle,drawTracker:g.prototype.drawTracker,getCenter:a.getCenter,getSymbol:y,isCartesian:!1,noSharedTooltip:!0,pointAttribs:g.prototype.pointAttribs,pointClass:C,requireSorting:!1,searchPoint:y,trackerGroups:["group","dataLabelsGroup"]});t.registerSeriesType("pie",n);return n});L(g,"Series/Pie/PieDataLabel.js",[g["Core/Series/DataLabel.js"],
g["Core/Globals.js"],g["Core/Renderer/RendererUtilities.js"],g["Core/Series/SeriesRegistry.js"],g["Core/Utilities.js"]],function(a,g,y,E,C){var z=g.noop,J=y.distribute,t=E.series,q=C.arrayMax,n=C.clamp,e=C.defined,d=C.merge,h=C.pick,m=C.relativeLength,k;(function(g){function k(){var a=this,g=a.data,f=a.chart,k=a.options.dataLabels||{},b=k.connectorPadding,m=f.plotWidth,n=f.plotHeight,p=f.plotLeft,r=Math.round(f.chartWidth/3),x=a.center,z=x[2]/2,y=x[1],B=[[],[]],C=[0,0,0,0],w=a.dataLabelPositioners,
D,G,I,E,H,K,L,X,R,U,Z,V;a.visible&&(k.enabled||a._hasPointLabels)&&(g.forEach(function(a){a.dataLabel&&a.visible&&a.dataLabel.shortened&&(a.dataLabel.attr({width:"auto"}).css({width:"auto",textOverflow:"clip"}),a.dataLabel.shortened=!1)}),t.prototype.drawDataLabels.apply(a),g.forEach(function(a){a.dataLabel&&(a.visible?(B[a.half].push(a),a.dataLabel._pos=null,!e(k.style.width)&&!e(a.options.dataLabels&&a.options.dataLabels.style&&a.options.dataLabels.style.width)&&a.dataLabel.getBBox().width>r&&(a.dataLabel.css({width:Math.round(.7*
r)+"px"}),a.dataLabel.shortened=!0)):(a.dataLabel=a.dataLabel.destroy(),a.dataLabels&&1===a.dataLabels.length&&delete a.dataLabels))}),B.forEach(function(c,d){var g=c.length,l=[],r;if(g){a.sortByAngle(c,d-.5);if(0<a.maxLabelDistance){var q=Math.max(0,y-z-a.maxLabelDistance),u=Math.min(y+z+a.maxLabelDistance,f.plotHeight);c.forEach(function(a){0<a.labelDistance&&a.dataLabel&&(a.top=Math.max(0,y-z-a.labelDistance),a.bottom=Math.min(y+z+a.labelDistance,f.plotHeight),r=a.dataLabel.getBBox().height||21,
a.distributeBox={target:a.labelPosition.natural.y-a.top+r/2,size:r,rank:a.y},l.push(a.distributeBox))});q=u+r-q;J(l,q,q/5)}for(Z=0;Z<g;Z++){D=c[Z];K=D.labelPosition;E=D.dataLabel;U=!1===D.visible?"hidden":"inherit";R=q=K.natural.y;l&&e(D.distributeBox)&&("undefined"===typeof D.distributeBox.pos?U="hidden":(L=D.distributeBox.size,R=w.radialDistributionY(D)));delete D.positionIndex;if(k.justify)X=w.justify(D,z,x);else switch(k.alignTo){case "connectors":X=w.alignToConnectors(c,d,m,p);break;case "plotEdges":X=
w.alignToPlotEdges(E,d,m,p);break;default:X=w.radialDistributionX(a,D,R,q)}E._attr={visibility:U,align:K.alignment};V=D.options.dataLabels||{};E._pos={x:X+h(V.x,k.x)+({left:b,right:-b}[K.alignment]||0),y:R+h(V.y,k.y)-10};K.final.x=X;K.final.y=R;h(k.crop,!0)&&(H=E.getBBox().width,q=null,X-H<b&&1===d?(q=Math.round(H-X+b),C[3]=Math.max(q,C[3])):X+H>m-b&&0===d&&(q=Math.round(X+H-m+b),C[1]=Math.max(q,C[1])),0>R-L/2?C[0]=Math.max(Math.round(-R+L/2),C[0]):R+L/2>n&&(C[2]=Math.max(Math.round(R+L/2-n),C[2])),
E.sideOverflow=q)}}}),0===q(C)||this.verifyDataLabelOverflow(C))&&(this.placeDataLabels(),this.points.forEach(function(b){V=d(k,b.options.dataLabels);if(G=h(V.connectorWidth,1)){var c;I=b.connector;if((E=b.dataLabel)&&E._pos&&b.visible&&0<b.labelDistance){U=E._attr.visibility;if(c=!I)b.connector=I=f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-"+b.colorIndex+(b.className?" "+b.className:"")).add(a.dataLabelsGroup),f.styledMode||I.attr({"stroke-width":G,stroke:V.connectorColor||
b.color||"#666666"});I[c?"attr":"animate"]({d:b.getConnectorPath()});I.attr("visibility",U)}else I&&(b.connector=I.destroy())}}))}function r(){this.points.forEach(function(a){var c=a.dataLabel,d;c&&a.visible&&((d=c._pos)?(c.sideOverflow&&(c._attr.width=Math.max(c.getBBox().width-c.sideOverflow,0),c.css({width:c._attr.width+"px",textOverflow:(this.options.dataLabels.style||{}).textOverflow||"ellipsis"}),c.shortened=!0),c.attr(c._attr),c[c.moved?"animate":"attr"](d),c.moved=!0):c&&c.attr({y:-9999}));
delete a.distributeBox},this)}function y(a){var c=this.center,d=this.options,e=d.center,b=d.minSize||80,g=null!==d.size;if(!g){if(null!==e[0])var h=Math.max(c[2]-Math.max(a[1],a[3]),b);else h=Math.max(c[2]-a[1]-a[3],b),c[0]+=(a[3]-a[1])/2;null!==e[1]?h=n(h,b,c[2]-Math.max(a[0],a[2])):(h=n(h,b,c[2]-a[0]-a[2]),c[1]+=(a[0]-a[2])/2);h<c[2]?(c[2]=h,c[3]=Math.min(d.thickness?Math.max(0,h-2*d.thickness):Math.max(0,m(d.innerSize||0,h)),h),this.translate(c),this.drawDataLabels&&this.drawDataLabels()):g=!0}return g}
var C=[],x={radialDistributionY:function(a){return a.top+a.distributeBox.pos},radialDistributionX:function(a,d,e,g){return a.getX(e<d.top+2||e>d.bottom-2?g:e,d.half,d)},justify:function(a,d,e){return e[0]+(a.half?-1:1)*(d+a.labelDistance)},alignToPlotEdges:function(a,d,e,g){a=a.getBBox().width;return d?a+g:e-a-g},alignToConnectors:function(a,d,e,g){var b=0,c;a.forEach(function(a){c=a.dataLabel.getBBox().width;c>b&&(b=c)});return d?b+g:e-b-g}};g.compose=function(c){a.compose(t);-1===C.indexOf(c)&&
(C.push(c),c=c.prototype,c.dataLabelPositioners=x,c.alignDataLabel=z,c.drawDataLabels=k,c.placeDataLabels=r,c.verifyDataLabelOverflow=y)}})(k||(k={}));return k});L(g,"Extensions/OverlappingDataLabels.js",[g["Core/Chart/Chart.js"],g["Core/Utilities.js"]],function(a,g){function y(a,e){var d=!1;if(a){var g=a.newOpacity;a.oldOpacity!==g&&(a.alignAttr&&a.placed?(a[g?"removeClass":"addClass"]("highcharts-data-label-hidden"),d=!0,a.alignAttr.opacity=g,a[a.isOld?"animate":"attr"](a.alignAttr,null,function(){e.styledMode||
a.css({pointerEvents:g?"auto":"none"})}),C(e,"afterHideOverlappingLabel")):a.attr({opacity:g}));a.isOld=!0}return d}var z=g.addEvent,C=g.fireEvent,D=g.isArray,J=g.isNumber,t=g.objectEach,q=g.pick;z(a,"render",function(){var a=this,e=[];(this.labelCollectors||[]).forEach(function(a){e=e.concat(a())});(this.yAxis||[]).forEach(function(a){a.stacking&&a.options.stackLabels&&!a.options.stackLabels.allowOverlap&&t(a.stacking.stacks,function(a){t(a,function(a){a.label&&e.push(a.label)})})});(this.series||
[]).forEach(function(d){var g=d.options.dataLabels;d.visible&&(!1!==g.enabled||d._hasPointLabels)&&(g=function(d){return d.forEach(function(d){d.visible&&(D(d.dataLabels)?d.dataLabels:d.dataLabel?[d.dataLabel]:[]).forEach(function(g){var h=g.options;g.labelrank=q(h.labelrank,d.labelrank,d.shapeArgs&&d.shapeArgs.height);h.allowOverlap?(g.oldOpacity=g.opacity,g.newOpacity=1,y(g,a)):e.push(g)})})},g(d.nodes||[]),g(d.points))});this.hideOverlappingLabels(e)});a.prototype.hideOverlappingLabels=function(a){var e=
this,d=a.length,g=e.renderer,m,k,n,q=!1,t=function(a){var c,d=a.box?0:a.padding||0,e=c=0,h;if(a&&(!a.alignAttr||a.placed)){var b=a.alignAttr||{x:a.attr("x"),y:a.attr("y")},k=a.parentGroup;a.width||(c=a.getBBox(),a.width=c.width,a.height=c.height,c=g.fontMetrics(null,a.element).h);var m=a.width-2*d;(h={left:"0",center:"0.5",right:"1"}[a.alignValue])?e=+h*m:J(a.x)&&Math.round(a.x)!==a.translateX&&(e=a.x-a.translateX);return{x:b.x+(k.translateX||0)+d-(e||0),y:b.y+(k.translateY||0)+d-c,width:a.width-
2*d,height:a.height-2*d}}};for(k=0;k<d;k++)if(m=a[k])m.oldOpacity=m.opacity,m.newOpacity=1,m.absoluteBox=t(m);a.sort(function(a,c){return(c.labelrank||0)-(a.labelrank||0)});for(k=0;k<d;k++){var z=(t=a[k])&&t.absoluteBox;for(m=k+1;m<d;++m){var D=(n=a[m])&&n.absoluteBox;!z||!D||t===n||0===t.newOpacity||0===n.newOpacity||"hidden"===t.visibility||"hidden"===n.visibility||D.x>=z.x+z.width||D.x+D.width<=z.x||D.y>=z.y+z.height||D.y+D.height<=z.y||((t.labelrank<n.labelrank?t:n).newOpacity=0)}}a.forEach(function(a){y(a,
e)&&(q=!0)});q&&C(e,"afterHideAllOverlappingLabels")}});L(g,"Core/Responsive.js",[g["Core/Utilities.js"]],function(a){var g=a.extend,y=a.find,E=a.isArray,C=a.isObject,D=a.merge,J=a.objectEach,t=a.pick,q=a.splat,n=a.uniqueKey,e;(function(a){var d=[];a.compose=function(a){-1===d.indexOf(a)&&(d.push(a),g(a.prototype,e.prototype));return a};var e=function(){function a(){}a.prototype.currentOptions=function(a){function d(a,g,c,h){var f;J(a,function(a,b){if(!h&&-1<e.collectionsWithUpdate.indexOf(b)&&g[b])for(a=
q(a),c[b]=[],f=0;f<Math.max(a.length,g[b].length);f++)g[b][f]&&(void 0===a[f]?c[b][f]=g[b][f]:(c[b][f]={},d(a[f],g[b][f],c[b][f],h+1)));else C(a)?(c[b]=E(a)?[]:{},d(a,g[b]||{},c[b],h+1)):c[b]="undefined"===typeof g[b]?null:g[b]})}var e=this,g={};d(a,this.options,g,0);return g};a.prototype.matchResponsiveRule=function(a,d){var e=a.condition;(e.callback||function(){return this.chartWidth<=t(e.maxWidth,Number.MAX_VALUE)&&this.chartHeight<=t(e.maxHeight,Number.MAX_VALUE)&&this.chartWidth>=t(e.minWidth,
0)&&this.chartHeight>=t(e.minHeight,0)}).call(this)&&d.push(a._id)};a.prototype.setResponsive=function(a,d){var e=this,g=this.options.responsive,h=this.currentResponsive,k=[];!d&&g&&g.rules&&g.rules.forEach(function(a){"undefined"===typeof a._id&&(a._id=n());e.matchResponsiveRule(a,k)},this);d=D.apply(void 0,k.map(function(a){return y((g||{}).rules||[],function(c){return c._id===a})}).map(function(a){return a&&a.chartOptions}));d.isResponsiveOptions=!0;k=k.toString()||void 0;k!==(h&&h.ruleIds)&&(h&&
this.update(h.undoOptions,a,!0),k?(h=this.currentOptions(d),h.isResponsiveOptions=!0,this.currentResponsive={ruleIds:k,mergedOptions:d,undoOptions:h},this.update(d,a,!0)):this.currentResponsive=void 0)};return a}()})(e||(e={}));"";"";return e});L(g,"masters/highcharts.src.js",[g["Core/Globals.js"],g["Core/Utilities.js"],g["Core/Defaults.js"],g["Core/Animation/Fx.js"],g["Core/Animation/AnimationUtilities.js"],g["Core/Renderer/HTML/AST.js"],g["Core/FormatUtilities.js"],g["Core/Renderer/RendererUtilities.js"],
g["Core/Renderer/SVG/SVGElement.js"],g["Core/Renderer/SVG/SVGRenderer.js"],g["Core/Renderer/HTML/HTMLElement.js"],g["Core/Renderer/HTML/HTMLRenderer.js"],g["Core/Axis/Axis.js"],g["Core/Axis/DateTimeAxis.js"],g["Core/Axis/LogarithmicAxis.js"],g["Core/Axis/PlotLineOrBand/PlotLineOrBand.js"],g["Core/Axis/Tick.js"],g["Core/Tooltip.js"],g["Core/Series/Point.js"],g["Core/Pointer.js"],g["Core/MSPointer.js"],g["Core/Legend/Legend.js"],g["Core/Chart/Chart.js"],g["Core/Axis/Stacking/StackingAxis.js"],g["Core/Axis/Stacking/StackItem.js"],
g["Core/Series/Series.js"],g["Core/Series/SeriesRegistry.js"],g["Series/Column/ColumnSeries.js"],g["Series/Column/ColumnDataLabel.js"],g["Series/Pie/PieSeries.js"],g["Series/Pie/PieDataLabel.js"],g["Core/Series/DataLabel.js"],g["Core/Responsive.js"],g["Core/Color/Color.js"],g["Core/Time.js"]],function(a,g,y,E,C,D,J,t,q,n,e,d,h,m,k,r,B,G,K,I,x,c,u,f,l,b,v,A,p,L,F,N,Q,W,Y){a.animate=C.animate;a.animObject=C.animObject;a.getDeferredAnimation=C.getDeferredAnimation;a.setAnimation=C.setAnimation;a.stop=
C.stop;a.timers=E.timers;a.AST=D;a.Axis=h;a.Chart=u;a.chart=u.chart;a.Fx=E;a.Legend=c;a.PlotLineOrBand=r;a.Point=K;a.Pointer=x.isRequired()?x:I;a.Series=b;a.StackItem=l;a.SVGElement=q;a.SVGRenderer=n;a.Tick=B;a.Time=Y;a.Tooltip=G;a.Color=W;a.color=W.parse;d.compose(n);e.compose(q);a.defaultOptions=y.defaultOptions;a.getOptions=y.getOptions;a.time=y.defaultTime;a.setOptions=y.setOptions;a.dateFormat=J.dateFormat;a.format=J.format;a.numberFormat=J.numberFormat;a.addEvent=g.addEvent;a.arrayMax=g.arrayMax;
a.arrayMin=g.arrayMin;a.attr=g.attr;a.clearTimeout=g.clearTimeout;a.correctFloat=g.correctFloat;a.createElement=g.createElement;a.css=g.css;a.defined=g.defined;a.destroyObjectProperties=g.destroyObjectProperties;a.discardElement=g.discardElement;a.distribute=t.distribute;a.erase=g.erase;a.error=g.error;a.extend=g.extend;a.extendClass=g.extendClass;a.find=g.find;a.fireEvent=g.fireEvent;a.getMagnitude=g.getMagnitude;a.getStyle=g.getStyle;a.inArray=g.inArray;a.isArray=g.isArray;a.isClass=g.isClass;a.isDOMElement=
g.isDOMElement;a.isFunction=g.isFunction;a.isNumber=g.isNumber;a.isObject=g.isObject;a.isString=g.isString;a.keys=g.keys;a.merge=g.merge;a.normalizeTickInterval=g.normalizeTickInterval;a.objectEach=g.objectEach;a.offset=g.offset;a.pad=g.pad;a.pick=g.pick;a.pInt=g.pInt;a.relativeLength=g.relativeLength;a.removeEvent=g.removeEvent;a.seriesType=v.seriesType;a.splat=g.splat;a.stableSort=g.stableSort;a.syncTimeout=g.syncTimeout;a.timeUnits=g.timeUnits;a.uniqueKey=g.uniqueKey;a.useSerialIds=g.useSerialIds;
a.wrap=g.wrap;p.compose(A);N.compose(b);m.compose(h);k.compose(h);F.compose(L);r.compose(h);Q.compose(u);f.compose(h,u,b);return a});g["masters/highcharts.src.js"]._modules=g;return g["masters/highcharts.src.js"]});