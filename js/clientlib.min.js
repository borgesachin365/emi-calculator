/*
 ...
 vb=/<([a-z][^\/\0>\x20\t\r\n\f]*)/i,wb=/^$|^module$|\/(?:java|ecma)script/i;var wa=v.createDocumentFragment().appendChild(v.createElement("div"));(Ua=v.createElement("input")).setAttribute("type","radio");Ua.setAttribute("checked","checked");Ua.setAttribute("name","t");wa.appendChild(Ua);y.checkClone=wa.cloneNode(!0).cloneNode(!0).lastChild.checked;wa.innerHTML="\x3ctextarea\x3ex\x3c/textarea\x3e";y.noCloneChecked=!!wa.cloneNode(!0).lastChild.defaultValue;wa.innerHTML="\x3coption\x3e\x3c/option\x3e";
 ...
 d.event={global:{},add:function(a,b,c,f,e){var g,h,l,k,m,p,n,t;var q=w.get(a);if(ua(a))for(c.handler&&(c=(g=c).handler,e=g.selector),e&&d.find.matchesSelector(Y,e),c.guid||(c.guid=d.guid++),(k=q.events)||(k=q.events=Object.create(null)),(h=q.handle)||(h=q.handle=function(b){return"undefined"!=typeof d&&d.event.triggered!==b.type?d.event.dispatch.apply(a,arguments):void 0}),q=(b=(b||"").match(O)||[""]).length;q--;){var r=t=(l=Tb.exec(b[q])||[])[1];l=(l[2]||"").split(".").sort();r&&(p=d.event.special[r]||
 ...
 m,p,n,t,q=w.hasData(a)&&w.get(a);if(q&&(k=q.events)){for(m=(b=(b||"").match(O)||[""]).length;m--;)if(p=t=(l=Tb.exec(b[m])||[])[1],n=(l[2]||"").split(".").sort(),p){var r=d.event.special[p]||{};var v=k[p=(f?r.delegateType:r.bindType)||p]||[];l=l[2]&&new RegExp("(^|\\.)"+n.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=v.length;g--;){var y=v[g];!e&&t!==y.origType||c&&c.guid!==y.guid||l&&!l.test(y.namespace)||f&&f!==y.selector&&("**"!==f||!y.selector)||(v.splice(g,1),y.selector&&v.delegateCount--,r.remove&&
 ...
 C(h);var m=0;for(f=(e=C(a)).length;m<f;m++){var p=e[m];var n=k[m];void 0;"input"===(g=n.nodeName.toLowerCase())&&va.test(p.type)?n.checked=p.checked:"input"!==g&&"textarea"!==g||(n.defaultValue=p.defaultValue)}}if(b)if(c)for(e=e||C(a),k=k||C(h),m=0,f=e.length;m<f;m++)yb(e[m],k[m]);else yb(a,h);return 0<(k=C(h,"script")).length&&Xa(k,!l&&C(a,"script")),h},cleanData:function(a){for(var b,c,f,e=d.event.special,g=0;void 0!==(c=a[g]);g++)if(ua(c)){if(b=c[w.expando]){if(b.events)for(f in b.events)e[f]?
 d.event.remove(c,f):d.removeEvent(c,f,b.handle);c[w.expando]=void 0}c[D.expando]&&(c[D.expando]=void 0)}}});d.fn.extend({detach:function(a){return Ab(this,a,!0)},remove:function(a){return Ab(this,a)},text:function(a){return Q(this,function(a){return void 0===a?d.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=a)})},null,a,arguments.length)},append:function(){return V(this,arguments,function(a){1!==this.nodeType&&11!==this.nodeType&&
 9!==this.nodeType||xb(this,a).appendChild(a)})},prepend:function(){return V(this,arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var b=xb(this,a);b.insertBefore(a,b.firstChild)}})},before:function(){return V(this,arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return V(this,arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},empty:function(){for(var a,b=0;null!=(a=this[b]);b++)1===
 ...
 d.fx.stop();oa=void 0};d.fx.timer=function(a){d.timers.push(a);d.fx.start()};d.fx.interval=13;d.fx.start=function(){Qa||(Qa=!0,db())};d.fx.stop=function(){Qa=null};d.fx.speeds={slow:600,fast:200,_default:400};d.fn.delay=function(a,b){return a=d.fx&&d.fx.speeds[a]||a,b=b||"fx",this.queue(b,function(b,d){var c=q.setTimeout(b,a);d.stop=function(){q.clearTimeout(c)}})};var Ba=v.createElement("input");var Fc=v.createElement("select").appendChild(v.createElement("option"));Ba.type="checkbox";y.checkOn=
 ""!==Ba.value;y.optSelected=Fc.selected;(Ba=v.createElement("input")).value="t";Ba.type="radio";y.radioValue="t"===Ba.value;var Ga=d.expr.attrHandle;d.fn.extend({attr:function(a,b){return Q(this,d.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){d.removeAttr(this,a)})}});d.extend({attr:function(a,b,c){var f,e,g=a.nodeType;if(3!==g&&8!==g&&2!==g)return"undefined"==typeof a.getAttribute?d.prop(a,b,c):(1===g&&d.isXMLDoc(a)||(e=d.attrHooks[b.toLowerCase()]||(d.expr.match.bool.test(b)?
